...
struct OnboardingInfo {                                 // Airi Opening Dialog
...
// suggest
struct SuggestReplyInfo {                               // Airi Auto-Suggestion
...
struct TaskInfo {                                // Scheduled Tasks on Airi
