...
struct LibraryResourceListRequest {
    ...
    5  : optional i32          size                 , // The number of data bars read at one time, the default is 10, and the maximum is 100.
...
struct ProjectResourceListRequest {
    ...
    2 : optional string project_version, // Specify the resources to obtain a version of the project
    255: base.Base Base  ,
}
