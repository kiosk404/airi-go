...
type GetPlaygroundPluginListRequest struct {
	...
	PluginIds    []string   `thrift:"plugin_ids,6" json:"plugin_ids"`
	PluginTypes  []int32    `thrift:"plugin_types,7" json:"plugin_types"`
...
type GetPluginAPIsRequest struct {
	...
	APIIds           []string             `thrift:"api_ids,2" json:"api_ids"`
...
type GetPluginAPIsResponse struct {
	...
	APIInfo     []*common.PluginAPIInfo `thrift:"api_info,3" json:"api_info"`
...
type GetUpdatedAPIsResponse struct {
	Code            int64          `thrift:"code,1" json:"code"`
	Msg             string         `thrift:"msg,2" json:"msg"`
	CreatedAPINames []string       `thrift:"created_api_names,3" json:"created_api_names"`
	DeletedAPINames []string       `thrift:"deleted_api_names,4" json:"deleted_api_names"`
	UpdatedAPINames []string       `thrift:"updated_api_names,5" json:"updated_api_names"`
	BaseResp        *base.BaseResp `thrift:"BaseResp,255,optional" json:"BaseResp,omitempty"`
}
...
type GetPluginInfoResponse struct {
	...
	PluginProductStatus common.ProductStatus        `thrift:"plugin_product_status,9" json:"plugin_product_status"`
	...
	CreationMethod      common.CreationMethod       `thrift:"creation_method,12" json:"creation_method"`
	...
	PluginType          common.PluginType           `thrift:"plugin_type,15" json:"plugin_type"`
	BaseResp            *base.BaseResp              `thrift:"BaseResp,255,optional" json:"BaseResp,omitempty"`
}
...
type RegisterPluginMetaRequest struct {
	...
	AuthType       *common.AuthorizationType                                `thrift:"auth_type,5,optional" json:"auth_type,omitempty"`
	Location       *common.AuthorizationServiceLocation                     `thrift:"location,6,optional" json:"location,omitempty"`
	...
	CommonParams   map[common.ParameterLocation][]*common.CommonParamSchema `thrift:"common_params,11,optional" json:"common_params,omitempty"`
	CreationMethod *common.CreationMethod                                   `thrift:"creation_method,12,optional" json:"creation_method,omitempty"`
	IdeCodeRuntime *string                                                  `thrift:"ide_code_runtime,13,optional" json:"ide_code_runtime,omitempty"`
	PluginType     *common.PluginType                                       `thrift:"plugin_type,14,optional" json:"plugin_type,omitempty"`
...
type UpdatePluginMetaRequest struct {
	...
	AuthType       *common.AuthorizationType                                `thrift:"auth_type,6,optional" json:"auth_type,omitempty"`
	Location       *common.AuthorizationServiceLocation                     `thrift:"location,7,optional" json:"location,omitempty"`
...
type GetBotDefaultParamsRequest struct {
	...
	PluginReferrerScene    common.PluginReferrerScene `thrift:"plugin_referrer_scene,7" json:"plugin_referrer_scene"`
...
type GetBotDefaultParamsResponse struct {
	Code           int64                  `thrift:"code,1" json:"code"`
	Msg            string                 `thrift:"msg,2" json:"msg"`
	RequestParams  []*common.APIParameter `thrift:"request_params,3" json:"request_params"`
	ResponseParams []*common.APIParameter `thrift:"response_params,4" json:"response_params"`
...
type UpdateBotDefaultParamsRequest struct {
	...
	PluginID            int64                      `thrift:"plugin_id,4" json:"plugin_id"`
	APIName             string                     `thrift:"api_name,5" json:"api_name"`
	RequestParams       []*common.APIParameter     `thrift:"request_params,6" json:"request_params"`
	ResponseParams      []*common.APIParameter     `thrift:"response_params,7" json:"response_params"`
	PluginReferrerID    string                     `thrift:"plugin_referrer_id,8" json:"plugin_referrer_id"`
	PluginReferrerScene common.PluginReferrerScene `thrift:"plugin_referrer_scene,9" json:"plugin_referrer_scene"`
...
type DeleteBotDefaultParamsRequest struct {
	...
	PluginReferrerScene common.PluginReferrerScene `thrift:"plugin_referrer_scene,8" json:"plugin_referrer_scene"`
	WorkflowID          string                     `thrift:"workflow_id,9" json:"workflow_id"`
...
type UpdateAPIRequest struct {
	...
	Method         *common.APIMethod      `thrift:"method,6,optional" json:"method,omitempty"`
	RequestParams  []*common.APIParameter `thrift:"request_params,7,optional" json:"request_params,omitempty"`
	ResponseParams []*common.APIParameter `thrift:"response_params,8,optional" json:"response_params,omitempty"`
...
type CreateAPIRequest struct {
	...
	Method         *common.APIMethod      `thrift:"method,5,optional" json:"method,omitempty"`
...
type GetUserAuthorityRequest struct {
	PluginID       int64                 `thrift:"plugin_id,1,required" json:"plugin_id"`
	CreationMethod common.CreationMethod `thrift:"creation_method,2,required" json:"creation_method"`
...
type GetOAuthStatusResponse struct {
	...
	Status   common.OAuthStatus `thrift:"status,2" json:"status"`
...
type GetPluginPublishHistoryResponse struct {
	Code                  int64                       `thrift:"code,1" json:"code"`
	Msg                   string                      `thrift:"msg,2" json:"msg"`
	PluginPublishInfoList []*common.PluginPublishInfo `thrift:"plugin_publish_info_list,3" json:"plugin_publish_info_list"`
	Total                 int32                       `thrift:"total,4" json:"total"`
	BaseResp              *base.BaseResp              `thrift:"BaseResp,255" json:"BaseResp"`
}
...
type DebugAPIRequest struct {
	...
	Operation   common.DebugOperation `thrift:"operation,4,required" json:"operation"`
...
type DebugAPIResponse struct {
	Code           int64                  `thrift:"code,1" json:"code"`
	Msg            string                 `thrift:"msg,2" json:"msg"`
	ResponseParams []*common.APIParameter `thrift:"response_params,3" json:"response_params"`
...
type RegisterPluginRequest struct {
	...
	PluginType     *common.PluginType `thrift:"plugin_type,7,optional" json:"plugin_type,omitempty"`
...
type GetDevPluginListRequest struct {
	Status              []common.PluginStatus       `thrift:"status,1,optional" json:"status,omitempty"`
	...
	ScopeType           *common.ScopeType           `thrift:"scope_type,6,optional" json:"scope_type,omitempty"`
	OrderBy             *common.OrderBy             `thrift:"order_by,7,optional" json:"order_by,omitempty"`
	...
	PluginTypeForFilter *common.PluginTypeForFilter `thrift:"plugin_type_for_filter,10,optional" json:"plugin_type_for_filter,omitempty"`
	ProjectID           int64                       `thrift:"project_id,11" json:"project_id"`
	PluginIds           []int64                     `thrift:"plugin_ids,12" json:"plugin_ids"`
	Base                *base.Base                  `thrift:"Base,255,optional" json:"Base,omitempty"`
}
...
type GetDevPluginListResponse struct {
	...
	Msg        string                            `thrift:"msg,2" json:"msg"`
	PluginList []*common.PluginInfoForPlayground `thrift:"plugin_list,3" json:"plugin_list"`
...
type Convert2OpenAPIResponse struct {
	...
	PluginDataFormat  *common.PluginDataFormat   `thrift:"plugin_data_format,5,optional" json:"plugin_data_format,omitempty"`
	DuplicateAPIInfos []*common.DuplicateAPIInfo `thrift:"duplicate_api_infos,6" json:"duplicate_api_infos"`
	BaseResp          *base.BaseResp             `thrift:"BaseResp,255,optional" json:"BaseResp,omitempty"`
}
...
type BatchCreateAPIRequest struct {
	...
	PathsToReplace   []*common.PluginAPIInfo `thrift:"paths_to_replace,7,optional" json:"paths_to_replace,omitempty"`
...
type BatchCreateAPIResponse struct {
	Code            int64                   `thrift:"code,1" json:"code"`
	Msg             string                  `thrift:"msg,2" json:"msg"`
	PathsDuplicated []*common.PluginAPIInfo `thrift:"paths_duplicated,3,optional" json:"paths_duplicated,omitempty"`
	PathsCreated    []*common.PluginAPIInfo `thrift:"paths_created,4,optional" json:"paths_created,omitempty"`
	EditVersion     int32                   `thrift:"edit_version,5" json:"edit_version"`
	BaseResp        *base.BaseResp          `thrift:"BaseResp,255,required" json:"BaseResp"`
}
...
type GetQueriedOAuthPluginListResponse struct {
	OauthPluginList []*OAuthPluginInfo `thrift:"oauth_plugin_list,1" json:"oauth_plugin_list"`
	Code            int64              `thrift:"code,253" json:"code"`
	Msg             string             `thrift:"msg,254" json:"msg"`
	BaseResp        *base.BaseResp     `thrift:"BaseResp,255,required" json:"BaseResp"`
}
