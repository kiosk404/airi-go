...
type ResponseStyle struct {
	WorkflowResponseMode WorkflowResponseMode `thrift:"workflow_response_mode,1" json:"workflow_response_mode"`
}
...
type APIListOrder struct {
	OrderBy APIListOrderBy `thrift:"order_by,1" json:"order_by"`
...
type PluginMetaInfo struct {
	...
	AuthType      []AuthorizationType                        `thrift:"auth_type,5" json:"auth_type"`
	Location      *AuthorizationServiceLocation              `thrift:"location,6,optional" json:"location,omitempty"`
	...
	CommonParams  map[ParameterLocation][]*CommonParamSchema `thrift:"common_params,10,optional" json:"common_params,omitempty"`
...
type GetPlaygroundPluginListData struct {
	PluginList []*PluginInfoForPlayground `thrift:"plugin_list,1" json:"plugin_list"`
...
type PluginInfoForPlayground struct {
	...
	PluginType              PluginType                                 `thrift:"plugin_type,5" json:"plugin_type"`
	Status                  PluginStatus                               `thrift:"status,6" json:"status"`
	...
	PluginApis              []*PluginApi                               `thrift:"plugin_apis,15" json:"plugin_apis"`
	...
	CommonParams            map[ParameterLocation][]*CommonParamSchema `thrift:"common_params,25,optional" json:"common_params,omitempty"`
	PluginProductStatus     ProductStatus                              `thrift:"plugin_product_status,26" json:"plugin_product_status"`
	PluginProductUnlistType ProductUnlistType                          `thrift:"plugin_product_unlist_type,27" json:"plugin_product_unlist_type"`
	MaterialID              string                                     `thrift:"material_id,28" json:"material_id"`
	ChannelID               int32                                      `thrift:"channel_id,29" json:"channel_id"`
	CreationMethod          CreationMethod                             `thrift:"creation_method,30" json:"creation_method"`
...
type PluginApi struct {
	Name            string                 `thrift:"name,1" json:"name"`
	Desc            string                 `thrift:"desc,2" json:"desc"`
	Parameters      []*PluginParameter     `thrift:"parameters,3" json:"parameters"`
	...
	RunMode         RunMode                `thrift:"run_mode,12" json:"run_mode"`
}
...
type Creator struct {
	...
	SpaceRolyType  SpaceRoleType `thrift:"space_roly_type,5" json:"space_roly_type"`
...
type PluginParameter struct {
	...
	SubParameters []*PluginParameter     `thrift:"sub_parameters,5" json:"sub_parameters"`
	...
	FromOutput    []string               `thrift:"from_output,8,optional" json:"from_output,omitempty"`
	Value         *string                `thrift:"value,9,optional" json:"value,omitempty"`
	Format        *PluginParamTypeFormat `thrift:"format,10,optional" json:"format,omitempty"`
}
...
type PluginAPIInfo struct {
	...
	Method             APIMethod              `thrift:"method,6" json:"method"`
	RequestParams      []*APIParameter        `thrift:"request_params,7" json:"request_params"`
	ResponseParams     []*APIParameter        `thrift:"response_params,8" json:"response_params"`
	CreateTime         string                 `thrift:"create_time,9" json:"create_time"`
	DebugStatus        APIDebugStatus         `thrift:"debug_status,10" json:"debug_status"`
	...
	OnlineStatus       OnlineStatus           `thrift:"online_status,13" json:"online_status"`
	...
	DebugExampleStatus DebugExampleStatus     `thrift:"debug_example_status,17" json:"debug_example_status"`
...
type APIParameter struct {
	...
	Type               ParameterType        `thrift:"type,4" json:"type"`
	SubType            *ParameterType       `thrift:"sub_type,5,optional" json:"sub_type,omitempty"`
	Location           ParameterLocation    `thrift:"location,6" json:"location"`
	IsRequired         bool                 `thrift:"is_required,7" json:"is_required"`
	SubParameters      []*APIParameter      `thrift:"sub_parameters,8" json:"sub_parameters"`
	...
	DefaultParamSource *DefaultParamSource  `thrift:"default_param_source,13,optional" json:"default_param_source,omitempty"`
	VariableRef        *string              `thrift:"variable_ref,14,optional" json:"variable_ref,omitempty"`
	AssistType         *AssistParameterType `thrift:"assist_type,15,optional" json:"assist_type,omitempty"`
}
...
type APIExtend struct {
	AuthMode PluginToolAuthType `thrift:"auth_mode,1" json:"auth_mode"`
}
...
type PresetCardBindingInfo struct {
	...
	Status         PluginCardStatus `thrift:"status,3" json:"status"`
