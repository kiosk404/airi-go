...
type ClearConversationHistoryRequest struct {
	...
	Scene          *common.Scene `thrift:"scene,2,optional" json:"scene,omitempty"`
...
type ClearConversationCtxRequest struct {
	ConversationID           int64         `thrift:"conversation_id,1,required" json:"conversation_id"`
	Scene                    *common.Scene `thrift:"scene,2,optional" json:"scene,omitempty"`
	InsertHistoryMessageList []string      `thrift:"insert_history_message_list,3,optional" json:"insert_history_message_list,omitempty"`
}
...
type ListConversationData struct {
	Conversations []*ConversationData `thrift:"conversations,1" json:"conversations"`
