...
type MsgParticipantInfo struct {
	...
	Type         MsgParticipantType `thrift:"type,2" json:"type"`
...
type SubmitToolOutputs struct {
	ToolCalls []*InterruptPlugin `thrift:"tool_calls,1" json:"tool_calls"`
}
...
type ChatMessageMetaInfo struct {
	Type ChatMessageMetaType `thrift:"type,1" json:"type"`
...
type ChatMessage struct {
	...
	MentionList      []*MsgParticipantInfo  `thrift:"mention_list,12,optional" json:"mention_list,omitempty"`
	...
	MetaInfos        []*ChatMessageMetaInfo `thrift:"meta_infos,18,optional" json:"meta_infos,omitempty"`
...
type GetMessageListRequest struct {
	...
	Scene                    *common.Scene  `thrift:"scene,7,optional" json:"scene,omitempty"`
	BizKind                  *string        `thrift:"biz_kind,8,optional" json:"biz_kind,omitempty"`
	InsertHistoryMessageList []string       `thrift:"insert_history_message_list,9,optional" json:"insert_history_message_list,omitempty"`
	LoadDirection            *LoadDirection `thrift:"load_direction,10,optional" json:"load_direction,omitempty"`
...
type GetMessageListResponse struct {
	MessageList             []*ChatMessage                 `thrift:"message_list,1,required" json:"message_list"`
	Cursor                  string                         `thrift:"cursor,2,required" json:"cursor"`
...
type DeleteMessageRequest struct {
	...
	Scene          *common.Scene `thrift:"scene,3,optional" json:"scene,omitempty"`
...
type BreakMessageRequest struct {
	...
	Scene           *common.Scene `thrift:"scene,5,optional" json:"scene,omitempty"`
}
...
type ListMessageApiResponse struct {
	Messages []*OpenMessageApi `thrift:"messages,1,optional" json:"messages,omitempty"`
