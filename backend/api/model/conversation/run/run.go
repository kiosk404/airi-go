...
type MixContentModel struct {
	...
	ReferItems []*Item `thrift:"refer_items,2" json:"refer_items"`
}
...
type AgentRunRequest struct {
	...
	Scene                    *common.Scene                 `thrift:"scene,11,optional" json:"scene,omitempty"`
	...
	InsertHistoryMessageList []string                      `thrift:"insert_history_message_list,16,optional" json:"insert_history_message_list,omitempty"`
	DeviceID                 *string                       `thrift:"device_id,17,optional" json:"device_id,omitempty"`
	MentionList              []*message.MsgParticipantInfo `thrift:"mention_list,18,optional" json:"mention_list,omitempty"`
	ToolList                 []*Tool                       `thrift:"toolList,19,optional" json:"toolList,omitempty"`
	...
	DiffModeIdentifier       *DiffModeIdentifier           `thrift:"diff_mode_identifier,22,optional" json:"diff_mode_identifier,omitempty"`
...
type ChatV3Request struct {
	...
	AdditionalMessages []*EnterMessage        `thrift:"AdditionalMessages,5,optional" json:"AdditionalMessages,omitempty"`
