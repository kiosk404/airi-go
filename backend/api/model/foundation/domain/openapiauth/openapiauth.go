...
type ListPersonalAccessTokensResponseData struct {
	PersonalAccessTokens []*PersonalAccessTokenWithCreatorInfo `thrift:"personal_access_tokens,1,required,list<PersonalAccessTokenWithCreatorInfo>" json:"personal_access_tokens"`
