...
type ModelConfig struct {
	...
	Stop             []string        `thrift:"stop,5,optional" json:"stop,omitempty"`
...
type Message struct {
	...
	MultimodalContents []*ChatMessagePart `thrift:"multimodal_contents,3,optional" json:"multimodal_contents,omitempty"`
	ToolCalls          []*ToolCall        `thrift:"tool_calls,4,optional" json:"tool_calls,omitempty"`
