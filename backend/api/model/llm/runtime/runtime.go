...
type ChatRequest struct {
	...
	Messages    []*runtime.Message   `thrift:"messages,2,optional,list<runtime.Message>" json:"messages,omitempty"`
	Tools       []*runtime.Tool      `thrift:"tools,3,optional,list<runtime.Tool>" json:"tools,omitempty"`
