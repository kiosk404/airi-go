...
type ShortMemoryPolicy struct {
	ContextMode  *ContextMode `thrift:"ContextMode,1,optional,ContextMode" json:"ContextMode,omitempty"`
...
type WorkflowInfo struct {
	...
	FlowMode     *WorkflowMode      `thrift:"FlowMode,4,optional,WorkflowMode" json:"FlowMode,omitempty"`
	...
	Parameters   []*PluginParameter `thrift:"Parameters,7,optional,list<PluginParameter>" json:"Parameters,omitempty"`
...
type PluginParameter struct {
	...
	SubParameters []*PluginParameter `thrift:"SubParameters,5,optional,list<PluginParameter>" json:"SubParameters,omitempty"`
...
type OnboardingInfo struct {
	...
	SuggestedQuestions         []string                    `thrift:"SuggestedQuestions,2,optional,list<string>" json:"SuggestedQuestions,omitempty"`
	OnboardingMode             *OnboardingMode             `thrift:"OnboardingMode,3,optional,OnboardingMode" json:"OnboardingMode,omitempty"`
	CustomizedOnboardingPrompt *string                     `thrift:"CustomizedOnboardingPrompt,4,optional" json:"CustomizedOnboardingPrompt,omitempty"`
	SuggestedQuestionsShowMode *SuggestedQuestionsShowMode `thrift:"SuggestedQuestionsShowMode,5,optional,SuggestedQuestionsShowMode" json:"SuggestedQuestionsShowMode,omitempty"`
}
...
type SuggestReplyInfo struct {
	SuggestReplyMode        *SuggestReplyMode `thrift:"SuggestReplyMode,1,optional,SuggestReplyMode" json:"SuggestReplyMode,omitempty"`
...
type VoicesInfo struct {
	...
	DefaultUserInputType *DefaultUserInputType `thrift:"DefaultUserInputType,6,optional,DefaultUserInputType" json:"DefaultUserInputType,omitempty"`
}
...
type AnswerActionTriggerRule struct {
	Type           AnswerActionTriggerType `thrift:"Type,1,default,AnswerActionTriggerType" json:"Type"`
...
type AnswerActions struct {
	AnswerActionsMode   AnswerActionsMode     `thrift:"AnswerActionsMode,1,default,AnswerActionsMode" json:"AnswerActionsMode"`
	AnswerActionConfigs []*AnswerActionConfig `thrift:"AnswerActionConfigs,2,default,list<AnswerActionConfig>" json:"AnswerActionConfigs"`
}
...
type BotExtInfo struct {
	...
	CardIds         []int32        `thrift:"CardIds,2,optional,list<i32>" json:"CardIds,omitempty"`
...
type Knowledge struct {
	KnowledgeInfo                []*KnowledgeInfo            `thrift:"KnowledgeInfo,1,optional,list<KnowledgeInfo>" json:"KnowledgeInfo,omitempty"`
	...
	SearchStrategy               *SearchStrategy             `thrift:"SearchStrategy,5,optional,SearchStrategy" json:"SearchStrategy,omitempty"`
	ShowSource                   *bool                       `thrift:"ShowSource,6,optional" json:"ShowSource,omitempty"`
	NoRecallReplyMode            *KnowledgeNoRecallReplyMode `thrift:"NoRecallReplyMode,7,optional,KnowledgeNoRecallReplyMode" json:"NoRecallReplyMode,omitempty"`
	...
	ShowSourceMode               *KnowledgeShowSourceMode    `thrift:"ShowSourceMode,9,optional,KnowledgeShowSourceMode" json:"ShowSourceMode,omitempty"`
...
type SocietyVisibiltyConfig struct {
	VisibilityType  SocietyVisibility `thrift:"VisibilityType,1,default,SocietyVisibility" json:"visibility_type,omitempty"`
	VisibilityRoles []string          `thrift:"VisibilityRoles,2,default,list<string>" json:"visibility_roles,omitempty"`
}
...
type FieldItem struct {
	Name         *string        `thrift:"Name,1,optional" json:"Name,omitempty"`
	Desc         *string        `thrift:"Desc,2,optional" json:"Desc,omitempty"`
	Type         *FieldItemType `thrift:"Type,3,optional,FieldItemType" json:"Type,omitempty"`
...
type Database struct {
	...
	FieldList      []*FieldItem    `thrift:"FieldList,4,optional,list<FieldItem>" json:"FieldList,omitempty"`
	PromptDisabled *bool           `thrift:"PromptDisabled,5,optional" json:"PromptDisabled,omitempty"`
	RWMode         *BotTableRWMode `thrift:"RWMode,6,optional,BotTableRWMode" json:"RWMode,omitempty"`
}
...
type Intent struct {
	...
	SessionType MultiAgentSessionType `thrift:"SessionType,4,default,MultiAgentSessionType" json:"SessionType"`
}
...
type TimeCapsuleInfo struct {
	TimeCapsuleMode      *TimeCapsuleMode      `thrift:"TimeCapsuleMode,1,optional,TimeCapsuleMode" json:"TimeCapsuleMode,omitempty"`
	DisablePromptCalling *DisablePromptCalling `thrift:"DisablePromptCalling,2,optional,DisablePromptCalling" json:"DisablePromptCalling,omitempty"`
}
...
type FileboxInfo struct {
	Mode *FileboxInfoMode `thrift:"Mode,1,optional,FileboxInfoMode" json:"Mode,omitempty"`
}
...
type CommonKnowledge struct {
	KnowledgeInfos []*KnowledgeInfo `thrift:"knowledge_infos,1,default,list<KnowledgeInfo>" json:"knowledge_infos"`
}
...
type ShortcutCommandComponent struct {
	...
	Options       []string `thrift:"options,5,optional,list<string>" json:"options,omitempty"`
...
type ShortcutCommandInfo struct {
	...
	Components    []*ShortcutCommandComponent `thrift:"components,7,optional,list<ShortcutCommandComponent>" json:"components,omitempty"`
...
type OpenAPIBotInfo struct {
	...
	BotMode              BotMode                `thrift:"bot_mode,10,default,BotMode" json:"bot_mode"`
	ModelInfo            *ModelInfo             `thrift:"model_info,12,optional" json:"model_info,omitempty"`
	PluginInfoList       []*PluginInfo          `thrift:"plugin_info_list,13,default,list<PluginInfo>" json:"plugin_info_list"`
	Knowledge            *CommonKnowledge       `thrift:"knowledge,14,optional" json:"knowledge,omitempty"`
	WorkflowInfoList     []*WorkflowInfo        `thrift:"workflow_info_list,15,default,list<WorkflowInfo>" json:"workflow_info_list"`
	ShortcutCommands     []*ShortcutCommandInfo `thrift:"shortcut_commands,16,default,list<ShortcutCommandInfo>" json:"shortcut_commands"`
	...
	Variables            []*Variable            `thrift:"variables,21,default,list<Variable>" json:"variables"`
}
...
type MultiAgentInfo struct {
	SessionType       MultiAgentSessionType   `thrift:"SessionType,1,default,MultiAgentSessionType" json:"SessionType"`
...
type AgentVersionCompatInfo struct {
	VersionCompat AgentVersionCompat `thrift:"VersionCompat,1,default,AgentVersionCompat" json:"VersionCompat"`
...
type AgentForUpdate struct {
	...
	PluginInfoList   []*PluginInfo       `thrift:"PluginInfoList,4,optional,list<PluginInfo>" json:"PluginInfoList,omitempty"`
	Knowledge        *Knowledge          `thrift:"Knowledge,5,optional" json:"Knowledge,omitempty"`
	WorkflowInfoList []*WorkflowInfo     `thrift:"WorkflowInfoList,6,optional,list<WorkflowInfo>" json:"WorkflowInfoList,omitempty"`
	ModelInfo        *ModelInfo          `thrift:"ModelInfo,7,optional" json:"ModelInfo,omitempty"`
	Intents          []*Intent           `thrift:"Intents,8,optional,list<Intent>" json:"Intents,omitempty"`
	AgentType        *AgentType          `thrift:"AgentType,9,optional,AgentType" json:"AgentType,omitempty"`
	...
	VersionCompat    *AgentVersionCompat `thrift:"VersionCompat,19,optional,AgentVersionCompat" json:"VersionCompat,omitempty"`
	HookInfo         *HookInfo           `thrift:"HookInfo,20,optional" json:"HookInfo,omitempty"`
}
...
type TaskPluginInput struct {
	Params []*TaskPluginInputField `thrift:"Params,1,optional,list<TaskPluginInputField>" json:"Params,omitempty"`
}
...
type TaskWebhookField struct {
	...
	Type        *string             `thrift:"Type,2,optional" json:"Type,omitempty"`
	Description *string             `thrift:"Description,3,optional" json:"Description,omitempty"`
	Children    []*TaskWebhookField `thrift:"Children,4,optional,list<TaskWebhookField>" json:"Children,omitempty"`
}
...
type TaskWebhookOutput struct {
	Params []*TaskWebhookField `thrift:"Params,1,optional,list<TaskWebhookField>" json:"Params,omitempty"`
}
...
type MessageFeedback struct {
	FeedbackType  MessageFeedbackType         `thrift:"feedback_type,1,default,MessageFeedbackType" json:"feedback_type"`
	DetailTypes   []MessageFeedbackDetailType `thrift:"detail_types,2,default,list<MessageFeedbackDetailType>" json:"detail_types"`
...
type HookInfo struct {
	PreAgentJumpHook  []*HookItem `thrift:"pre_agent_jump_hook,1,optional,list<HookItem>" json:"pre_agent_jump_hook,omitempty"`
	PostAgentJumpHook []*HookItem `thrift:"post_agent_jump_hook,2,optional,list<HookItem>" json:"post_agent_jump_hook,omitempty"`
	FlowHook          []*HookItem `thrift:"flow_hook,3,optional,list<HookItem>" json:"flow_hook,omitempty"`
	AtomicHook        []*HookItem `thrift:"atomic_hook,4,optional,list<HookItem>" json:"atomic_hook,omitempty"`
	LlmCallHook       []*HookItem `thrift:"llm_call_hook,5,optional,list<HookItem>" json:"llm_call_hook,omitempty"`
	ResParsingHook    []*HookItem `thrift:"res_parsing_hook,6,optional,list<HookItem>" json:"res_parsing_hook,omitempty"`
	SuggestionHook    []*HookItem `thrift:"suggestion_hook,7,optional,list<HookItem>" json:"suggestion_hook,omitempty"`
}
...
type HookItem struct {
	...
	FilterRules []string `thrift:"filter_rules,2,optional,list<string>" json:"filter_rules,omitempty"`
