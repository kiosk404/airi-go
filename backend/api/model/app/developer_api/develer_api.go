...
type DraftBotCreateRequest struct {
	...
	Visibility       VisibilityType           `thrift:"visibility,5" json:"visibility"`
	...
	BusinessType     *bot_common.BusinessType `thrift:"business_type,9,optional" json:"business_type,omitempty"`
}
...
type TabDisplayItems struct {
	PluginTabStatus           *TabStatus `thrift:"plugin_tab_status,1,optional" json:"plugin_tab_status,omitempty"`
	WorkflowTabStatus         *TabStatus `thrift:"workflow_tab_status,2,optional" json:"workflow_tab_status,omitempty"`
	KnowledgeTabStatus        *TabStatus `thrift:"knowledge_tab_status,3,optional" json:"knowledge_tab_status,omitempty"`
	DatabaseTabStatus         *TabStatus `thrift:"database_tab_status,4,optional" json:"database_tab_status,omitempty"`
	VariableTabStatus         *TabStatus `thrift:"variable_tab_status,5,optional" json:"variable_tab_status,omitempty"`
	OpeningDialogTabStatus    *TabStatus `thrift:"opening_dialog_tab_status,6,optional" json:"opening_dialog_tab_status,omitempty"`
	ScheduledTaskTabStatus    *TabStatus `thrift:"scheduled_task_tab_status,7,optional" json:"scheduled_task_tab_status,omitempty"`
	SuggestionTabStatus       *TabStatus `thrift:"suggestion_tab_status,8,optional" json:"suggestion_tab_status,omitempty"`
	TtsTabStatus              *TabStatus `thrift:"tts_tab_status,9,optional" json:"tts_tab_status,omitempty"`
	FileboxTabStatus          *TabStatus `thrift:"filebox_tab_status,10,optional" json:"filebox_tab_status,omitempty"`
	LongTermMemoryTabStatus   *TabStatus `thrift:"long_term_memory_tab_status,11,optional" json:"long_term_memory_tab_status,omitempty"`
	AnswerActionTabStatus     *TabStatus `thrift:"answer_action_tab_status,12,optional" json:"answer_action_tab_status,omitempty"`
	ImageflowTabStatus        *TabStatus `thrift:"imageflow_tab_status,13,optional" json:"imageflow_tab_status,omitempty"`
	BackgroundImageTabStatus  *TabStatus `thrift:"background_image_tab_status,14,optional" json:"background_image_tab_status,omitempty"`
	ShortcutTabStatus         *TabStatus `thrift:"shortcut_tab_status,15,optional" json:"shortcut_tab_status,omitempty"`
	KnowledgeTableTabStatus   *TabStatus `thrift:"knowledge_table_tab_status,16,optional" json:"knowledge_table_tab_status,omitempty"`
	KnowledgeTextTabStatus    *TabStatus `thrift:"knowledge_text_tab_status,17,optional" json:"knowledge_text_tab_status,omitempty"`
	KnowledgePhotoTabStatus   *TabStatus `thrift:"knowledge_photo_tab_status,18,optional" json:"knowledge_photo_tab_status,omitempty"`
	HookInfoTabStatus         *TabStatus `thrift:"hook_info_tab_status,19,optional" json:"hook_info_tab_status,omitempty"`
	DefaultUserInputTabStatus *TabStatus `thrift:"default_user_input_tab_status,20,optional" json:"default_user_input_tab_status,omitempty"`
}
...
type PublishDraftBotData struct {
	ConnectorBindResult       map[string][]*ConnectorBindResult `thrift:"connector_bind_result,1" json:"connector_bind_result"`
	...
	NotPassReason             []string                          `thrift:"not_pass_reason,6,optional" json:"not_pass_reason,omitempty"`
...
type ConnectorBindResult struct {
	...
	PublishResultStatus *PublishResultStatus `thrift:"publish_result_status,4,optional" json:"publish_result_status,omitempty"`
}
...
type AgentInfo struct {
	...
	AgentType           *AgentType           `thrift:"agent_type,2,optional" json:"agent_type,omitempty"`
	...
	Intents             []*Intent            `thrift:"intents,6,optional" json:"intents,omitempty"`
	...
	ReferenceInfoStatus *ReferenceInfoStatus `thrift:"reference_info_status,11,optional" json:"reference_info_status,omitempty"`
	Description         *string              `thrift:"description,12,optional" json:"description,omitempty"`
	UpdateType          *ReferenceUpdateType `thrift:"update_type,13,optional" json:"update_type,omitempty"`
}
...
type PublishDraftBotRequest struct {
	...
	ConnectorList         map[string][]*Connector      `thrift:"connector_list,4" json:"connector_list"`
	Connectors            map[string]map[string]string `thrift:"connectors,5" json:"connectors"`
	BotMode               *BotMode                     `thrift:"botMode,6,optional" json:"botMode,omitempty"`
	Agents                []*AgentInfo                 `thrift:"agents,7,optional" json:"agents,omitempty"`
	CanvasData            *string                      `thrift:"canvas_data,8,optional" json:"canvas_data,omitempty"`
	BotTagInfo            []*BotTagInfo                `thrift:"bot_tag_info,9,optional" json:"bot_tag_info,omitempty"`
	...
	PublishType           *PublishType                 `thrift:"publish_type,13,optional" json:"publish_type,omitempty"`
...
type ListDraftBotHistoryRequest struct {
	...
	HistoryType HistoryType `thrift:"history_type,5,required" json:"history_type"`
...
type ListDraftBotHistoryData struct {
	HistoryInfos []*HistoryInfo `thrift:"history_infos,1" json:"history_infos"`
...
type HistoryInfo struct {
	...
	HistoryType    HistoryType      `thrift:"history_type,2" json:"history_type"`
	Info           string           `thrift:"info,3" json:"info"`
	CreateTime     string           `thrift:"create_time,4" json:"create_time"`
	ConnectorInfos []*ConnectorInfo `thrift:"connector_infos,5" json:"connector_infos"`
...
type ConnectorInfo struct {
	...
	ConnectorStatus ConnectorDynamicStatus `thrift:"connector_status,4" json:"connector_status"`
...
type GetIconRequest struct {
	IconType IconType `thrift:"icon_type,1" json:"icon_type"`
}
...
type GetIconResponseData struct {
	IconList []*Icon `thrift:"icon_list,1" json:"icon_list"`
}
...
type CommonFileInfo struct {
	...
	BizType  FileBizType `thrift:"biz_type,2" json:"biz_type"`
}
...
type GetTypeListRequest struct {
	...
	CurModelIds []string    `thrift:"cur_model_ids,6,optional" json:"cur_model_ids,omitempty"`
	ModelScene  *ModelScene `thrift:"model_scene,7,optional" json:"model_scene,omitempty"`
}
...
type ModelParameter struct {
	...
	Type       ModelParamType          `thrift:"type,4,required" json:"type"`
	...
	Options    []*Option               `thrift:"options,9" json:"options"`
...
type ModelTag struct {
	...
	TagClass        ModelTagClass `thrift:"tag_class,2" json:"tag_class"`
...
type ModelStatusDetails struct {
	...
	ModelFeature         ModelTagValue `thrift:"model_feature,22" json:"model_feature"`
}
...
type Model struct {
	...
	ModelClass         ModelClass                                                          `thrift:"model_class,3" json:"model_class"`
	...
	ModelParams        []*ModelParameter                                                   `thrift:"model_params,11" json:"model_params"`
	ModelDesc          []*ModelDescGroup                                                   `thrift:"model_desc,12,optional" json:"model_desc,omitempty"`
	FuncConfig         map[bot_common.ModelFuncConfigType]bot_common.ModelFuncConfigStatus `thrift:"func_config,13,optional" json:"func_config,omitempty"`
	EndpointName       *string                                                             `thrift:"endpoint_name,14,optional" json:"endpoint_name,omitempty"`
	ModelTagList       []*ModelTag                                                         `thrift:"model_tag_list,15,optional" json:"model_tag_list,omitempty"`
...
type GetTypeListData struct {
	ModelList    []*Model     `thrift:"model_list,1" json:"model_list"`
	VoiceList    []*VoiceType `thrift:"voice_list,2" json:"voice_list"`
	RawModelList []*Model     `thrift:"raw_model_list,3" json:"raw_model_list"`
}
...
type CheckDraftBotCommitData struct {
	Status            *CommitStatus `thrift:"status,1,optional" json:"status,omitempty"`
...
type OnboardingContent struct {
	...
	SuggestedQuestions []string `thrift:"suggested_questions,2,optional" json:"suggested_questions,omitempty"`
}
...
type PublishConnectorInfo struct {
	...
	ConfigStatus        ConfigStatus        `thrift:"config_status,6,required" json:"config_status"`
	LastPublishTime     int64               `thrift:"last_publish_time,7,required" json:"last_publish_time"`
	BindType            BindType            `thrift:"bind_type,8,required" json:"bind_type"`
	...
	AllowPunish         *AllowPublishStatus `thrift:"allow_punish,16,optional" json:"allow_punish,omitempty"`
	...
	AuthStatus          *UserAuthStatus     `thrift:"auth_status,21,optional" json:"auth_status,omitempty"`
