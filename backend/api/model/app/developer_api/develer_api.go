...
type DraftBotCreateRequest struct {
	...
	Visibility       VisibilityType           `thrift:"visibility,5,default,VisibilityType" json:"visibility"`
	MonetizationConf *MonetizationConf        `thrift:"monetization_conf,6,optional" json:"monetization_conf,omitempty"`
	CreateFrom       *string                  `thrift:"create_from,7,optional" json:"create_from,omitempty"`
	BusinessType     *bot_common.BusinessType `thrift:"business_type,9,optional,BusinessType" json:"business_type,omitempty"`
}
...
func (p *DraftBotCreateRequest) SetSpaceID(val int64) {
	p.SpaceID = val
}
...
func (p *DeleteDraftBotRequest) SetSpaceID(val int64) {
	p.SpaceID = val
}
...
func (p *DuplicateDraftBotRequest) SetSpaceID(val int64) {
	p.SpaceID = val
}
...
type UpdateDraftBotDisplayInfoRequest struct {
	...
	SpaceID     *string                  `thrift:"space_id,3,optional" json:"space_id,omitempty"`
}
...
func (p *UpdateDraftBotDisplayInfoRequest) SetSpaceID(val *string) {
	p.SpaceID = val
}
