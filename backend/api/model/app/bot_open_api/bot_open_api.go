...
type WorkspacePermission struct {
	WorkspaceIDList []string `thrift:"workspace_id_list,1" json:"workspace_id_list"`
	PermissionList  []string `thrift:"permission_list,2" json:"permission_list"`
}
...
type AccountPermission struct {
	PermissionList []string `thrift:"permission_list,1" json:"permission_list"`
}
