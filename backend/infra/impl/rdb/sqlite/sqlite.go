...
import (
	...
	sqlparsercontract "github.com/kiosk404/airi-go/backend/infra/contract/sqlparser"
	"github.com/kiosk404/airi-go/backend/infra/impl/sqlparser"
...
func New() (*gorm.DB, error) {
	...
	if err != nil {
		return nil, fmt.Errorf("mysql open, dsn: %s, err: %w", dbpath, err)
	}
...
func (m *sqliteService) CreateTable(ctx context.Context, req *rdb.CreateTableRequest) (*rdb.CreateTableResponse, error) {
	...
	logs.Info("[CreateTable] execute sql is %s, req is %v", createSQL, req)
...
func (m *sqliteService) AlterTable(ctx context.Context, req *rdb.AlterTableRequest) (*rdb.AlterTableResponse, error) {
	...
	logs.Info("[AlterTable] execute sql is %s, req is %v", alterSQL, req)
...
func (m *sqliteService) DropTable(ctx context.Context, req *rdb.DropTableRequest) (*rdb.DropTableResponse, error) {
	if req == nil {
		return nil, fmt.Errorf("invalid request")
	}
	...
	logs.Info("[DropTable] execute sql is %s, req is %v", dropSQL, req)
...
func (m *sqliteService) GetTable(ctx context.Context, req *rdb.GetTableRequest) (*rdb.GetTableResponse, error) {
	if req == nil {
		return nil, fmt.Errorf("invalid request")
	}
...
func (m *sqliteService) InsertData(ctx context.Context, req *rdb.InsertDataRequest) (*rdb.InsertDataResponse, error) {
	...
	for i := 0; i < len(req.Data); i += batchSize {
		...
		logs.Info("[InsertData] execute sql is %s, value is %v in batch %d", insertSQL, values, i)
...
func (m *sqliteService) UpdateData(ctx context.Context, req *rdb.UpdateDataRequest) (*rdb.UpdateDataResponse, error) {
	if req == nil {
		return nil, fmt.Errorf("invalid request")
	}
	...
	logs.Info("[UpdateData] execute sql is %s, value is %v, req is %v", updateSQL, values, req)
...
func (m *sqliteService) DeleteData(ctx context.Context, req *rdb.DeleteDataRequest) (*rdb.DeleteDataResponse, error) {
	if req == nil {
		return nil, fmt.Errorf("invalid request")
	}
	...
	logs.Info("[DeleteData] execute sql is %s, value is %v, req is %v", deleteSQL, whereValues, req)
...
func (m *sqliteService) SelectData(ctx context.Context, req *rdb.SelectDataRequest) (*rdb.SelectDataResponse, error) {
	if req == nil {
		return nil, fmt.Errorf("invalid request")
	}
	...
	logs.Info("[SelectData] execute sql is %s, value is %v, req is %v", selectSQL, whereValues, req)
...
func (m *sqliteService) UpsertData(ctx context.Context, req *rdb.UpsertDataRequest) (*rdb.UpsertDataResponse, error) {
	if req == nil || len(req.Data) == 0 {
	...
	for i := 0; i < len(req.Data); i += batchSize {
		...
		logs.Info("[UpsertData] execute sql is %s, value is %v, batch is %d", upsertSQL, values, i)
...
func (m *sqliteService) getTablePrimaryKeys(ctx context.Context, tableName string) ([]string, error) {
	query := `
        SELECT COLUMN_NAME
...
func (m *sqliteService) ExecuteSQL(ctx context.Context, req *rdb.ExecuteSQLRequest) (*rdb.ExecuteSQLResponse, error) {
	if req == nil {
		return nil, fmt.Errorf("invalid request")
	}

	logs.Info("[ExecuteSQL] req is %v", req)
...
func (m *sqliteService) processSliceParams(sql string, params []interface{}) (string, []interface{}, error) {
	if len(params) == 0 {
...
func (m *sqliteService) isSlice(param interface{}) bool {
	if param == nil {
		return false
	}
...
func (m *sqliteService) getSliceValues(param interface{}) ([]interface{}, error) {
	rv := reflect.ValueOf(param)
...
func (m *sqliteService) genTableName(ctx context.Context) (string, error) {
...
func (m *sqliteService) getTableInfo(ctx context.Context, tableName string) (*entity.Table, error) {
	tableInfoSQL := `
        SELECT 
            TABLE_NAME,
            TABLE_COLLATION,
...
func (m *sqliteService) buildWhereClause(condition *rdb.ComplexCondition) (string, []interface{}, error) {
	if condition == nil {
		return "", nil, nil
	}
