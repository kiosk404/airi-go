module github.com/kiosk404/airi-go/backend
...
require (
	...
	github.com/cloudwego/eino-ext/components/model/claude v0.1.3
	...
	github.com/cloudwego/eino-ext/components/model/qwen v0.0.0-20250904121005-ad78ed3e5e49
