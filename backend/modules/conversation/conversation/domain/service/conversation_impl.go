...
import (
	...
	"github.com/kiosk404/airi-go/backend/modules/conversation/conversation/domain/repo"
)
...
func (c *conversationImpl) List(ctx context.Context, req *entity.ListMeta) ([]*entity.Conversation, bool, error) {
	conversationList, hasMore, err := c.ConversationRepo.List(ctx, req.UserID, req.AgentID, int32(req.Scene), req.Limit, req.Page)
