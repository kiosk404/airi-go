...
type singleAgentDraft struct {
	singleAgentDraftDo singleAgentDraftDo
...
func (s *singleAgentDraft) WithContext(ctx context.Context) *singleAgentDraftDo {
	return s.singleAgentDraftDo.WithContext(ctx)
}

func (s singleAgentDraft) TableName() string { return s.singleAgentDraftDo.TableName() }

func (s singleAgentDraft) Alias() string { return s.singleAgentDraftDo.Alias() }

func (s singleAgentDraft) Columns(cols ...field.Expr) gen.Columns {
	return s.singleAgentDraftDo.Columns(cols...)
}
...
func (s singleAgentDraftDo) Debug() *singleAgentDraftDo {
	return s.withDO(s.DO.Debug())
}

func (s singleAgentDraftDo) WithContext(ctx context.Context) *singleAgentDraftDo {
	return s.withDO(s.DO.WithContext(ctx))
}

func (s singleAgentDraftDo) ReadDB() *singleAgentDraftDo {
	return s.Clauses(dbresolver.Read)
}

func (s singleAgentDraftDo) WriteDB() *singleAgentDraftDo {
	return s.Clauses(dbresolver.Write)
}

func (s singleAgentDraftDo) Session(config *gorm.Session) *singleAgentDraftDo {
	return s.withDO(s.DO.Session(config))
}

func (s singleAgentDraftDo) Clauses(conds ...clause.Expression) *singleAgentDraftDo {
	return s.withDO(s.DO.Clauses(conds...))
}

func (s singleAgentDraftDo) Returning(value interface{}, columns ...string) *singleAgentDraftDo {
	return s.withDO(s.DO.Returning(value, columns...))
}

func (s singleAgentDraftDo) Not(conds ...gen.Condition) *singleAgentDraftDo {
	return s.withDO(s.DO.Not(conds...))
}

func (s singleAgentDraftDo) Or(conds ...gen.Condition) *singleAgentDraftDo {
	return s.withDO(s.DO.Or(conds...))
}

func (s singleAgentDraftDo) Select(conds ...field.Expr) *singleAgentDraftDo {
	return s.withDO(s.DO.Select(conds...))
}

func (s singleAgentDraftDo) Where(conds ...gen.Condition) *singleAgentDraftDo {
	return s.withDO(s.DO.Where(conds...))
}

func (s singleAgentDraftDo) Order(conds ...field.Expr) *singleAgentDraftDo {
	return s.withDO(s.DO.Order(conds...))
}

func (s singleAgentDraftDo) Distinct(cols ...field.Expr) *singleAgentDraftDo {
	return s.withDO(s.DO.Distinct(cols...))
}

func (s singleAgentDraftDo) Omit(cols ...field.Expr) *singleAgentDraftDo {
	return s.withDO(s.DO.Omit(cols...))
}

func (s singleAgentDraftDo) Join(table schema.Tabler, on ...field.Expr) *singleAgentDraftDo {
	return s.withDO(s.DO.Join(table, on...))
}

func (s singleAgentDraftDo) LeftJoin(table schema.Tabler, on ...field.Expr) *singleAgentDraftDo {
	return s.withDO(s.DO.LeftJoin(table, on...))
}

func (s singleAgentDraftDo) RightJoin(table schema.Tabler, on ...field.Expr) *singleAgentDraftDo {
	return s.withDO(s.DO.RightJoin(table, on...))
}

func (s singleAgentDraftDo) Group(cols ...field.Expr) *singleAgentDraftDo {
	return s.withDO(s.DO.Group(cols...))
}

func (s singleAgentDraftDo) Having(conds ...gen.Condition) *singleAgentDraftDo {
	return s.withDO(s.DO.Having(conds...))
}

func (s singleAgentDraftDo) Limit(limit int) *singleAgentDraftDo {
	return s.withDO(s.DO.Limit(limit))
}

func (s singleAgentDraftDo) Offset(offset int) *singleAgentDraftDo {
	return s.withDO(s.DO.Offset(offset))
}

func (s singleAgentDraftDo) Scopes(funcs ...func(gen.Dao) gen.Dao) *singleAgentDraftDo {
	return s.withDO(s.DO.Scopes(funcs...))
}

func (s singleAgentDraftDo) Unscoped() *singleAgentDraftDo {
...
func (s singleAgentDraftDo) Attrs(attrs ...field.AssignExpr) *singleAgentDraftDo {
	return s.withDO(s.DO.Attrs(attrs...))
}

func (s singleAgentDraftDo) Assign(attrs ...field.AssignExpr) *singleAgentDraftDo {
	return s.withDO(s.DO.Assign(attrs...))
}

func (s singleAgentDraftDo) Joins(fields ...field.RelationField) *singleAgentDraftDo {
...
func (s singleAgentDraftDo) Preload(fields ...field.RelationField) *singleAgentDraftDo {
	for _, _f := range fields {
