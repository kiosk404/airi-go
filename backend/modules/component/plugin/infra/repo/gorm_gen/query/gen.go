...
type queryCtx struct {
	AgentToolDraft   *agentToolDraftDo
	AgentToolVersion *agentToolVersionDo
	Plugin           *pluginDo
	PluginDraft      *pluginDraftDo
	PluginOauthAuth  *pluginOauthAuthDo
	PluginVersion    *pluginVersionDo
	Tool             *toolDo
	ToolDraft        *toolDraftDo
	ToolVersion      *toolVersionDo
}
