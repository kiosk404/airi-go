...
func (t *toolVersion) WithContext(ctx context.Context) *toolVersionDo {
	return t.toolVersionDo.WithContext(ctx)
}

func (t toolVersion) TableName() string { return t.toolVersionDo.TableName() }

func (t toolVersion) Alias() string { return t.toolVersionDo.Alias() }

func (t toolVersion) Columns(cols ...field.Expr) gen.Columns { return t.toolVersionDo.Columns(cols...) }
...
func (t toolVersionDo) Debug() *toolVersionDo {
	return t.withDO(t.DO.Debug())
}

func (t toolVersionDo) WithContext(ctx context.Context) *toolVersionDo {
	return t.withDO(t.DO.WithContext(ctx))
}

func (t toolVersionDo) ReadDB() *toolVersionDo {
	return t.Clauses(dbresolver.Read)
}

func (t toolVersionDo) WriteDB() *toolVersionDo {
	return t.Clauses(dbresolver.Write)
}

func (t toolVersionDo) Session(config *gorm.Session) *toolVersionDo {
	return t.withDO(t.DO.Session(config))
}

func (t toolVersionDo) Clauses(conds ...clause.Expression) *toolVersionDo {
	return t.withDO(t.DO.Clauses(conds...))
}

func (t toolVersionDo) Returning(value interface{}, columns ...string) *toolVersionDo {
	return t.withDO(t.DO.Returning(value, columns...))
}

func (t toolVersionDo) Not(conds ...gen.Condition) *toolVersionDo {
	return t.withDO(t.DO.Not(conds...))
}

func (t toolVersionDo) Or(conds ...gen.Condition) *toolVersionDo {
	return t.withDO(t.DO.Or(conds...))
}

func (t toolVersionDo) Select(conds ...field.Expr) *toolVersionDo {
	return t.withDO(t.DO.Select(conds...))
}

func (t toolVersionDo) Where(conds ...gen.Condition) *toolVersionDo {
	return t.withDO(t.DO.Where(conds...))
}

func (t toolVersionDo) Order(conds ...field.Expr) *toolVersionDo {
	return t.withDO(t.DO.Order(conds...))
}

func (t toolVersionDo) Distinct(cols ...field.Expr) *toolVersionDo {
	return t.withDO(t.DO.Distinct(cols...))
}

func (t toolVersionDo) Omit(cols ...field.Expr) *toolVersionDo {
	return t.withDO(t.DO.Omit(cols...))
}

func (t toolVersionDo) Join(table schema.Tabler, on ...field.Expr) *toolVersionDo {
	return t.withDO(t.DO.Join(table, on...))
}

func (t toolVersionDo) LeftJoin(table schema.Tabler, on ...field.Expr) *toolVersionDo {
	return t.withDO(t.DO.LeftJoin(table, on...))
}

func (t toolVersionDo) RightJoin(table schema.Tabler, on ...field.Expr) *toolVersionDo {
	return t.withDO(t.DO.RightJoin(table, on...))
}

func (t toolVersionDo) Group(cols ...field.Expr) *toolVersionDo {
	return t.withDO(t.DO.Group(cols...))
}

func (t toolVersionDo) Having(conds ...gen.Condition) *toolVersionDo {
	return t.withDO(t.DO.Having(conds...))
}

func (t toolVersionDo) Limit(limit int) *toolVersionDo {
	return t.withDO(t.DO.Limit(limit))
}

func (t toolVersionDo) Offset(offset int) *toolVersionDo {
	return t.withDO(t.DO.Offset(offset))
}

func (t toolVersionDo) Scopes(funcs ...func(gen.Dao) gen.Dao) *toolVersionDo {
	return t.withDO(t.DO.Scopes(funcs...))
}

func (t toolVersionDo) Unscoped() *toolVersionDo {
...
func (t toolVersionDo) Attrs(attrs ...field.AssignExpr) *toolVersionDo {
	return t.withDO(t.DO.Attrs(attrs...))
}

func (t toolVersionDo) Assign(attrs ...field.AssignExpr) *toolVersionDo {
	return t.withDO(t.DO.Assign(attrs...))
}

func (t toolVersionDo) Joins(fields ...field.RelationField) *toolVersionDo {
...
func (t toolVersionDo) Preload(fields ...field.RelationField) *toolVersionDo {
	for _, _f := range fields {
