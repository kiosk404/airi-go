...
type agentToolVersion struct {
	agentToolVersionDo agentToolVersionDo
...
func (a *agentToolVersion) WithContext(ctx context.Context) *agentToolVersionDo {
	return a.agentToolVersionDo.WithContext(ctx)
}

func (a agentToolVersion) TableName() string { return a.agentToolVersionDo.TableName() }

func (a agentToolVersion) Alias() string { return a.agentToolVersionDo.Alias() }

func (a agentToolVersion) Columns(cols ...field.Expr) gen.Columns {
	return a.agentToolVersionDo.Columns(cols...)
}
...
func (a agentToolVersionDo) Debug() *agentToolVersionDo {
	return a.withDO(a.DO.Debug())
}

func (a agentToolVersionDo) WithContext(ctx context.Context) *agentToolVersionDo {
	return a.withDO(a.DO.WithContext(ctx))
}

func (a agentToolVersionDo) ReadDB() *agentToolVersionDo {
	return a.Clauses(dbresolver.Read)
}

func (a agentToolVersionDo) WriteDB() *agentToolVersionDo {
	return a.Clauses(dbresolver.Write)
}

func (a agentToolVersionDo) Session(config *gorm.Session) *agentToolVersionDo {
	return a.withDO(a.DO.Session(config))
}

func (a agentToolVersionDo) Clauses(conds ...clause.Expression) *agentToolVersionDo {
	return a.withDO(a.DO.Clauses(conds...))
}

func (a agentToolVersionDo) Returning(value interface{}, columns ...string) *agentToolVersionDo {
	return a.withDO(a.DO.Returning(value, columns...))
}

func (a agentToolVersionDo) Not(conds ...gen.Condition) *agentToolVersionDo {
	return a.withDO(a.DO.Not(conds...))
}

func (a agentToolVersionDo) Or(conds ...gen.Condition) *agentToolVersionDo {
	return a.withDO(a.DO.Or(conds...))
}

func (a agentToolVersionDo) Select(conds ...field.Expr) *agentToolVersionDo {
	return a.withDO(a.DO.Select(conds...))
}

func (a agentToolVersionDo) Where(conds ...gen.Condition) *agentToolVersionDo {
	return a.withDO(a.DO.Where(conds...))
}

func (a agentToolVersionDo) Order(conds ...field.Expr) *agentToolVersionDo {
	return a.withDO(a.DO.Order(conds...))
}

func (a agentToolVersionDo) Distinct(cols ...field.Expr) *agentToolVersionDo {
	return a.withDO(a.DO.Distinct(cols...))
}

func (a agentToolVersionDo) Omit(cols ...field.Expr) *agentToolVersionDo {
	return a.withDO(a.DO.Omit(cols...))
}

func (a agentToolVersionDo) Join(table schema.Tabler, on ...field.Expr) *agentToolVersionDo {
	return a.withDO(a.DO.Join(table, on...))
}

func (a agentToolVersionDo) LeftJoin(table schema.Tabler, on ...field.Expr) *agentToolVersionDo {
	return a.withDO(a.DO.LeftJoin(table, on...))
}

func (a agentToolVersionDo) RightJoin(table schema.Tabler, on ...field.Expr) *agentToolVersionDo {
	return a.withDO(a.DO.RightJoin(table, on...))
}

func (a agentToolVersionDo) Group(cols ...field.Expr) *agentToolVersionDo {
	return a.withDO(a.DO.Group(cols...))
}

func (a agentToolVersionDo) Having(conds ...gen.Condition) *agentToolVersionDo {
	return a.withDO(a.DO.Having(conds...))
}

func (a agentToolVersionDo) Limit(limit int) *agentToolVersionDo {
	return a.withDO(a.DO.Limit(limit))
}

func (a agentToolVersionDo) Offset(offset int) *agentToolVersionDo {
	return a.withDO(a.DO.Offset(offset))
}

func (a agentToolVersionDo) Scopes(funcs ...func(gen.Dao) gen.Dao) *agentToolVersionDo {
	return a.withDO(a.DO.Scopes(funcs...))
}

func (a agentToolVersionDo) Unscoped() *agentToolVersionDo {
...
func (a agentToolVersionDo) Attrs(attrs ...field.AssignExpr) *agentToolVersionDo {
	return a.withDO(a.DO.Attrs(attrs...))
}

func (a agentToolVersionDo) Assign(attrs ...field.AssignExpr) *agentToolVersionDo {
	return a.withDO(a.DO.Assign(attrs...))
}

func (a agentToolVersionDo) Joins(fields ...field.RelationField) *agentToolVersionDo {
...
func (a agentToolVersionDo) Preload(fields ...field.RelationField) *agentToolVersionDo {
	for _, _f := range fields {
