...
type agentToolDraft struct {
	agentToolDraftDo agentToolDraftDo
...
func (a *agentToolDraft) WithContext(ctx context.Context) *agentToolDraftDo {
	return a.agentToolDraftDo.WithContext(ctx)
}

func (a agentToolDraft) TableName() string { return a.agentToolDraftDo.TableName() }

func (a agentToolDraft) Alias() string { return a.agentToolDraftDo.Alias() }

func (a agentToolDraft) Columns(cols ...field.Expr) gen.Columns {
	return a.agentToolDraftDo.Columns(cols...)
}
...
func (a agentToolDraftDo) Debug() *agentToolDraftDo {
	return a.withDO(a.DO.Debug())
}

func (a agentToolDraftDo) WithContext(ctx context.Context) *agentToolDraftDo {
	return a.withDO(a.DO.WithContext(ctx))
}

func (a agentToolDraftDo) ReadDB() *agentToolDraftDo {
	return a.Clauses(dbresolver.Read)
}

func (a agentToolDraftDo) WriteDB() *agentToolDraftDo {
	return a.Clauses(dbresolver.Write)
}

func (a agentToolDraftDo) Session(config *gorm.Session) *agentToolDraftDo {
	return a.withDO(a.DO.Session(config))
}

func (a agentToolDraftDo) Clauses(conds ...clause.Expression) *agentToolDraftDo {
	return a.withDO(a.DO.Clauses(conds...))
}

func (a agentToolDraftDo) Returning(value interface{}, columns ...string) *agentToolDraftDo {
	return a.withDO(a.DO.Returning(value, columns...))
}

func (a agentToolDraftDo) Not(conds ...gen.Condition) *agentToolDraftDo {
	return a.withDO(a.DO.Not(conds...))
}

func (a agentToolDraftDo) Or(conds ...gen.Condition) *agentToolDraftDo {
	return a.withDO(a.DO.Or(conds...))
}

func (a agentToolDraftDo) Select(conds ...field.Expr) *agentToolDraftDo {
	return a.withDO(a.DO.Select(conds...))
}

func (a agentToolDraftDo) Where(conds ...gen.Condition) *agentToolDraftDo {
	return a.withDO(a.DO.Where(conds...))
}

func (a agentToolDraftDo) Order(conds ...field.Expr) *agentToolDraftDo {
	return a.withDO(a.DO.Order(conds...))
}

func (a agentToolDraftDo) Distinct(cols ...field.Expr) *agentToolDraftDo {
	return a.withDO(a.DO.Distinct(cols...))
}

func (a agentToolDraftDo) Omit(cols ...field.Expr) *agentToolDraftDo {
	return a.withDO(a.DO.Omit(cols...))
}

func (a agentToolDraftDo) Join(table schema.Tabler, on ...field.Expr) *agentToolDraftDo {
	return a.withDO(a.DO.Join(table, on...))
}

func (a agentToolDraftDo) LeftJoin(table schema.Tabler, on ...field.Expr) *agentToolDraftDo {
	return a.withDO(a.DO.LeftJoin(table, on...))
}

func (a agentToolDraftDo) RightJoin(table schema.Tabler, on ...field.Expr) *agentToolDraftDo {
	return a.withDO(a.DO.RightJoin(table, on...))
}

func (a agentToolDraftDo) Group(cols ...field.Expr) *agentToolDraftDo {
	return a.withDO(a.DO.Group(cols...))
}

func (a agentToolDraftDo) Having(conds ...gen.Condition) *agentToolDraftDo {
	return a.withDO(a.DO.Having(conds...))
}

func (a agentToolDraftDo) Limit(limit int) *agentToolDraftDo {
	return a.withDO(a.DO.Limit(limit))
}

func (a agentToolDraftDo) Offset(offset int) *agentToolDraftDo {
	return a.withDO(a.DO.Offset(offset))
}

func (a agentToolDraftDo) Scopes(funcs ...func(gen.Dao) gen.Dao) *agentToolDraftDo {
	return a.withDO(a.DO.Scopes(funcs...))
}

func (a agentToolDraftDo) Unscoped() *agentToolDraftDo {
...
func (a agentToolDraftDo) Attrs(attrs ...field.AssignExpr) *agentToolDraftDo {
	return a.withDO(a.DO.Attrs(attrs...))
}

func (a agentToolDraftDo) Assign(attrs ...field.AssignExpr) *agentToolDraftDo {
	return a.withDO(a.DO.Assign(attrs...))
}

func (a agentToolDraftDo) Joins(fields ...field.RelationField) *agentToolDraftDo {
...
func (a agentToolDraftDo) Preload(fields ...field.RelationField) *agentToolDraftDo {
	for _, _f := range fields {
