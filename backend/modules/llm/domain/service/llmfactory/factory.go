...
type IFactory interface {
	CreateLLM(ctx context.Context, model *entity.Model, opts ...model.Option) (llminterface.ILLM, error)
}
...
func (f *FactoryImpl) CreateLLM(ctx context.Context, model *entity.Model, opts ...model.Option) (llminterface.ILLM, error) {
