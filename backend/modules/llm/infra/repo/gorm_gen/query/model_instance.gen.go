...
type modelInstance struct {
	modelInstanceDo modelInstanceDo
...
func (m *modelInstance) WithContext(ctx context.Context) *modelInstanceDo {
	return m.modelInstanceDo.WithContext(ctx)
}

func (m modelInstance) TableName() string { return m.modelInstanceDo.TableName() }

func (m modelInstance) Alias() string { return m.modelInstanceDo.Alias() }

func (m modelInstance) Columns(cols ...field.Expr) gen.Columns {
	return m.modelInstanceDo.Columns(cols...)
}
...
func (m modelInstanceDo) Debug() *modelInstanceDo {
	return m.withDO(m.DO.Debug())
}

func (m modelInstanceDo) WithContext(ctx context.Context) *modelInstanceDo {
	return m.withDO(m.DO.WithContext(ctx))
}

func (m modelInstanceDo) ReadDB() *modelInstanceDo {
	return m.Clauses(dbresolver.Read)
}

func (m modelInstanceDo) WriteDB() *modelInstanceDo {
	return m.Clauses(dbresolver.Write)
}

func (m modelInstanceDo) Session(config *gorm.Session) *modelInstanceDo {
	return m.withDO(m.DO.Session(config))
}

func (m modelInstanceDo) Clauses(conds ...clause.Expression) *modelInstanceDo {
	return m.withDO(m.DO.Clauses(conds...))
}

func (m modelInstanceDo) Returning(value interface{}, columns ...string) *modelInstanceDo {
	return m.withDO(m.DO.Returning(value, columns...))
}

func (m modelInstanceDo) Not(conds ...gen.Condition) *modelInstanceDo {
	return m.withDO(m.DO.Not(conds...))
}

func (m modelInstanceDo) Or(conds ...gen.Condition) *modelInstanceDo {
	return m.withDO(m.DO.Or(conds...))
}

func (m modelInstanceDo) Select(conds ...field.Expr) *modelInstanceDo {
	return m.withDO(m.DO.Select(conds...))
}

func (m modelInstanceDo) Where(conds ...gen.Condition) *modelInstanceDo {
	return m.withDO(m.DO.Where(conds...))
}

func (m modelInstanceDo) Order(conds ...field.Expr) *modelInstanceDo {
	return m.withDO(m.DO.Order(conds...))
}

func (m modelInstanceDo) Distinct(cols ...field.Expr) *modelInstanceDo {
	return m.withDO(m.DO.Distinct(cols...))
}

func (m modelInstanceDo) Omit(cols ...field.Expr) *modelInstanceDo {
	return m.withDO(m.DO.Omit(cols...))
}

func (m modelInstanceDo) Join(table schema.Tabler, on ...field.Expr) *modelInstanceDo {
	return m.withDO(m.DO.Join(table, on...))
}

func (m modelInstanceDo) LeftJoin(table schema.Tabler, on ...field.Expr) *modelInstanceDo {
	return m.withDO(m.DO.LeftJoin(table, on...))
}

func (m modelInstanceDo) RightJoin(table schema.Tabler, on ...field.Expr) *modelInstanceDo {
	return m.withDO(m.DO.RightJoin(table, on...))
}

func (m modelInstanceDo) Group(cols ...field.Expr) *modelInstanceDo {
	return m.withDO(m.DO.Group(cols...))
}

func (m modelInstanceDo) Having(conds ...gen.Condition) *modelInstanceDo {
	return m.withDO(m.DO.Having(conds...))
}

func (m modelInstanceDo) Limit(limit int) *modelInstanceDo {
	return m.withDO(m.DO.Limit(limit))
}

func (m modelInstanceDo) Offset(offset int) *modelInstanceDo {
	return m.withDO(m.DO.Offset(offset))
}

func (m modelInstanceDo) Scopes(funcs ...func(gen.Dao) gen.Dao) *modelInstanceDo {
	return m.withDO(m.DO.Scopes(funcs...))
}

func (m modelInstanceDo) Unscoped() *modelInstanceDo {
...
func (m modelInstanceDo) Attrs(attrs ...field.AssignExpr) *modelInstanceDo {
	return m.withDO(m.DO.Attrs(attrs...))
}

func (m modelInstanceDo) Assign(attrs ...field.AssignExpr) *modelInstanceDo {
	return m.withDO(m.DO.Assign(attrs...))
}

func (m modelInstanceDo) Joins(fields ...field.RelationField) *modelInstanceDo {
...
func (m modelInstanceDo) Preload(fields ...field.RelationField) *modelInstanceDo {
	for _, _f := range fields {
