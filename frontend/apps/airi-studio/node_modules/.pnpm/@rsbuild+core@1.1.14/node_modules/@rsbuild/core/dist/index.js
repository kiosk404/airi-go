...
import * as __WEBPACK_EXTERNAL_MODULE_node_events__ from "node:events";
...
import * as __WEBPACK_EXTERNAL_MODULE_node_querystring__ from "node:querystring";
import * as __WEBPACK_EXTERNAL_MODULE_node_vm__ from "node:vm";
var EsmMode, __webpack_modules__ = {
    ...
    "node:events": function(module) {
        module.exports = __WEBPACK_EXTERNAL_MODULE_node_events__;
    },
    ...
    "node:process": function(module) {
        module.exports = __WEBPACK_EXTERNAL_MODULE_node_process__;
    },
    os: function(module) {
    ...
    "../../node_modules/.pnpm/commander@12.1.0/node_modules/commander/index.js": function(__unused_webpack_module, exports, __webpack_require__) {
        ...
        exports.program = new Command(), exports.createCommand = (name)=>new Command(name), exports.createOption = (flags, description)=>new Option(flags, description), exports.createArgument = (name, description)=>new Argument(name, description), exports.Command = Command, exports.Option = Option, exports.Argument = Argument, exports.Help = Help, exports.CommanderError = CommanderError, exports.InvalidArgumentError = InvalidArgumentError, exports.InvalidOptionArgumentError = InvalidArgumentError;
    },
    "../../node_modules/.pnpm/commander@12.1.0/node_modules/commander/lib/argument.js": function(__unused_webpack_module, exports, __webpack_require__) {
        let { InvalidArgumentError } = __webpack_require__("../../node_modules/.pnpm/commander@12.1.0/node_modules/commander/lib/error.js");
        exports.Argument = class Argument {
    ...
    "../../node_modules/.pnpm/commander@12.1.0/node_modules/commander/lib/command.js": function(__unused_webpack_module, exports, __webpack_require__) {
...
Expecting one of '${allowedValues.join("', '")}'`);
    ...
    "../../node_modules/.pnpm/commander@12.1.0/node_modules/commander/lib/error.js": function(__unused_webpack_module, exports) {
        ...
        exports.CommanderError = CommanderError, exports.InvalidArgumentError = class InvalidArgumentError extends CommanderError {
            constructor(message){
                super(1, 'commander.invalidArgument', message), Error.captureStackTrace(this, this.constructor), this.name = this.constructor.name;
            }
        };
    },
    "../../node_modules/.pnpm/commander@12.1.0/node_modules/commander/lib/help.js": function(__unused_webpack_module, exports, __webpack_require__) {
    ...
    "../../node_modules/.pnpm/commander@12.1.0/node_modules/commander/lib/option.js": function(__unused_webpack_module, exports, __webpack_require__) {
        let { InvalidArgumentError } = __webpack_require__("../../node_modules/.pnpm/commander@12.1.0/node_modules/commander/lib/error.js");
        ...
        }, exports.DualOptions = class DualOptions {
            constructor(options){
    ...
    "../../node_modules/.pnpm/commander@12.1.0/node_modules/commander/lib/suggestSimilar.js": function(__unused_webpack_module, exports) {
...
let isFileSync = (filePath)=>{
    try {
        var _fs_statSync;
        return null === (_fs_statSync = external_node_fs_.default.statSync(filePath, {
            throwIfNoEntry: !1
...
async function emptyDir(dir) {
    if (!!await pathExists(dir)) try {
        for (let file of (await external_node_fs_.default.promises.readdir(dir)))await external_node_fs_.default.promises.rm(external_node_path_.default.resolve(dir, file), {
            recursive: !0,
            force: !0
        });
    } catch (err) {
        __WEBPACK_EXTERNAL_MODULE__compiled_rslog_index_js__.logger.debug(`Failed to empty dir: ${dir}`), __WEBPACK_EXTERNAL_MODULE__compiled_rslog_index_js__.logger.debug(err);
    }
}
...
function formatStats(statsData, hasErrors) {
    ...
    if (warnings.length) {
        let title = __WEBPACK_EXTERNAL_MODULE__compiled_picocolors_index_js__.default.bold(__WEBPACK_EXTERNAL_MODULE__compiled_picocolors_index_js__.default.yellow('Compile Warning: \n'));
        return {
...
let camelCase = (input)=>input.replace(/[-_](\w)/g, (_, c)=>c.toUpperCase()), prettyTime = (seconds)=>{
    let format = (time)=>__WEBPACK_EXTERNAL_MODULE__compiled_picocolors_index_js__.default.bold(time);
    if (seconds < 10) {
...
async function config_loadConfig({ cwd = process.cwd(), path, envMode, meta } = {}) {
    ...
    if (/\.(?:js|mjs|cjs)$/.test(configFilePath)) try {
        ...
        __WEBPACK_EXTERNAL_MODULE__compiled_rslog_index_js__.logger.debug(`Failed to load file with dynamic import: ${__WEBPACK_EXTERNAL_MODULE__compiled_picocolors_index_js__.default.dim(configFilePath)}`);
    }
    try {
        ...
        throw __WEBPACK_EXTERNAL_MODULE__compiled_rslog_index_js__.logger.error(`Failed to load file with jiti: ${__WEBPACK_EXTERNAL_MODULE__compiled_picocolors_index_js__.default.dim(configFilePath)}`), err;
    }
...
async function outputInspectConfigFiles({ rawBundlerConfigs, rawEnvironmentConfigs, inspectOptions, configType }) {
    ...
    let fileInfos = files.map((item)=>`  - ${__WEBPACK_EXTERNAL_MODULE__compiled_picocolors_index_js__.default.bold(__WEBPACK_EXTERNAL_MODULE__compiled_picocolors_index_js__.default.yellow(item.label))}: ${__WEBPACK_EXTERNAL_MODULE__compiled_picocolors_index_js__.default.underline(item.path)}`).join('\n');
    __WEBPACK_EXTERNAL_MODULE__compiled_rslog_index_js__.logger.success(`Inspect config succeed, open following files to view the content: \n\n${fileInfos}\n`);
}
function stringifyConfig(config, verbose) {
    return (0, __WEBPACK_EXTERNAL_MODULE__compiled_rspack_chain_index_js__.default.toString)(config, {
        verbose
    });
}
...
async function initPlugins({ getPluginAPI, pluginManager }) {
    __WEBPACK_EXTERNAL_MODULE__compiled_rslog_index_js__.logger.debug('init plugins');
    ...
    __WEBPACK_EXTERNAL_MODULE__compiled_rslog_index_js__.logger.debug('init plugins done');
}
    ...
    let result = function(opts) {
        ...
        if (opts.path) {
            let config = function(from) {
                let resolved;
                let fromDir = isFile(from = external_node_path_.default.resolve(from)) ? external_node_path_.default.dirname(from) : from;
                if (fromDir in configCache) return configCache[fromDir];
                let configFile = eachParent(from, (dir)=>{
                    let pkgBrowserslist;
                    let config = external_node_path_.default.join(dir, 'browserslist'), pkg = external_node_path_.default.join(dir, 'package.json'), rc = external_node_path_.default.join(dir, '.browserslistrc');
                    if (isFile(pkg)) try {
...
let getEnvironmentHTMLPaths = (entry, config)=>'web' !== config.output.target || !1 === config.tools.htmlPlugin ? {} : Object.keys(entry).reduce((prev, key)=>{
        ...
        return ('string' == typeof entryValue || Array.isArray(entryValue) || !1 !== entryValue.html) && (prev[key] = function(entryName, config) {
            ...
            return prefix.startsWith('/') && __WEBPACK_EXTERNAL_MODULE__compiled_rslog_index_js__.logger.warn(`Absolute path is not recommended at \`output.distPath.html\`: "${prefix}", please use relative path instead.`), removeLeadingSlash(external_node_path_.posix.join(prefix, filename));
        }(key, config)), prev;
    }, {});
async function updateEnvironmentContext(context, configs) {
    for (let [index, [name, config]] of (context.environments ||= {}, Object.entries(configs).entries())){
        ...
        context.environments[name] = new Proxy(environmentContext, {
            ...
            set: (_, prop)=>(__WEBPACK_EXTERNAL_MODULE__compiled_rslog_index_js__.logger.error(`EnvironmentContext is readonly, you can not assign to the "environment.${prop}" prop.`), !0)
        });
    }
}
            ...
            let htmlTagsMap = new Map(), iconFormatMap = new Map(), formatIcon = (icon, distDir, publicPath)=>{
                ...
                if (isURL(src)) {
                    let paths = {
                        ...
                        absolutePath: src,
                        relativePath: src,
                        mimeType: (0, __WEBPACK_EXTERNAL_MODULE__compiled_mrmime_index_js__.lookup)(src)
                    };
                ...
                let absolutePath = external_node_path_.default.isAbsolute(src) ? src : external_node_path_.default.join(api.context.rootPath, src), relativePath = external_node_path_.default.posix.join(distDir, external_node_path_.default.basename(absolutePath)), paths = {
                    sizes,
                    requestPath: ensureAssetPrefix(relativePath, publicPath),
                    absolutePath,
                    relativePath,
                    mimeType: (0, __WEBPACK_EXTERNAL_MODULE__compiled_mrmime_index_js__.lookup)(absolutePath)
                };
                return iconFormatMap.set(src, paths), {
                    ...paths,
                    ...icon
            ...
            api.processAssets({
                ...
                for (let icon of icons){
                    ...
                    if (!icon.isURL) {
                        ...
                        let source = await (0, __WEBPACK_EXTERNAL_MODULE_node_util__.promisify)(compilation.inputFileSystem.readFile)(icon.absolutePath);
        ...
        setup (api) {
            api.modifyBundlerChain((chain, { isProd, environment })=>{
                let { config } = environment, getMergedFilename = (assetType)=>{
                    ...
                    return external_node_path_.default.posix.join(distDir, filename);
...
async function validateCache(cacheDirectory, buildDependencies) {
    ...
    if (await isFileExists(configFile)) {
        if (JSON.stringify(JSON.parse(await external_node_fs_.default.promises.readFile(configFile, 'utf-8'))) === JSON.stringify(buildDependencies)) return;
        await external_node_fs_.default.promises.rm(cacheDirectory, {
            force: !0,
            recursive: !0
        });
    }
    await external_node_fs_.default.promises.mkdir(cacheDirectory, {
        recursive: !0
    }), await external_node_fs_.default.promises.writeFile(configFile, JSON.stringify(buildDependencies));
}
...
let pluginCache = ()=>({
        ...
        setup (api) {
            if ('rspack' !== api.context.bundlerType) api.modifyBundlerChain(async (chain, { environment, env })=>{
                ...
                chain.cache({
                    name: useDigest ? `${environment.name}-${env}-${digest = cacheConfig.cacheDigest, __WEBPACK_EXTERNAL_MODULE_node_crypto__.default.createHash('md5').update(JSON.stringify(digest)).digest('hex').slice(0, 8)}` : `${environment.name}-${env}`,
                    type: 'filesystem',
                    cacheDirectory,
                    buildDependencies
                });
    ...
    return parentDir !== childDir && childDir.startsWith(parentDir);
        ...
        setup (api) {
            let getRsbuildCleanPath = ()=>{
                ...
                if ('auto' === cleanDistPath && !(cleanDistPath = isStrictSubdir(rootPath, distPath)) && (__WEBPACK_EXTERNAL_MODULE__compiled_rslog_index_js__.logger.warn('The dist path is not a subdir of root path, Rsbuild will not empty it.'), __WEBPACK_EXTERNAL_MODULE__compiled_rslog_index_js__.logger.warn(`Please set ${__WEBPACK_EXTERNAL_MODULE__compiled_picocolors_index_js__.default.yellow('`output.cleanDistPath`')} config manually.`), __WEBPACK_EXTERNAL_MODULE__compiled_rslog_index_js__.logger.warn(`Current root path: ${__WEBPACK_EXTERNAL_MODULE__compiled_picocolors_index_js__.default.dim(rootPath)}`), __WEBPACK_EXTERNAL_MODULE__compiled_rslog_index_js__.logger.warn(`Current dist path: ${__WEBPACK_EXTERNAL_MODULE__compiled_picocolors_index_js__.default.dim(distPath)}`)), cleanDistPath) return distPath;
...
async function printFileSizes(options, stats, rootPath, environmentName) {
    ...
    let longestLabelLength = Math.max(...assets.map((a)=>a.sizeLabel.length)), longestFileLength = Math.max(...assets.map((a)=>(a.folder + external_node_path_.default.sep + a.name).length));
    !1 !== options.detail && logs.push(function(longestFileLength, longestLabelLength, options, environmentName) {
        ...
        return __WEBPACK_EXTERNAL_MODULE__compiled_picocolors_index_js__.default.blue(headerRow);
    ...
    for (let asset of assets){
        ...
        if (totalSize += asset.size, asset.gzippedSize && (totalGzipSize += asset.gzippedSize), !1 !== options.detail) {
            ...
            let fileNameLabel = __WEBPACK_EXTERNAL_MODULE__compiled_picocolors_index_js__.default.dim(asset.folder + external_node_path_.default.sep) + coloringAssetName(asset.name);
        ...
        setup (api) {
            api.onAfterBuild(async ({ stats, environments, isFirstCompile })=>{
                ...
                await Promise.all(Object.values(environments).map(async (environment, index)=>{
                    ...
                    logs.length && logs.push(__WEBPACK_EXTERNAL_MODULE__compiled_picocolors_index_js__.default.dim('  -----')), logs.push(...statsLogs);
                })).catch((err)=>{
                    __WEBPACK_EXTERNAL_MODULE__compiled_rslog_index_js__.logger.warn('Failed to print file size.'), __WEBPACK_EXTERNAL_MODULE__compiled_rslog_index_js__.logger.warn(err);
                }), __WEBPACK_EXTERNAL_MODULE__compiled_rslog_index_js__.logger.log(logs.join('\n'));
            });
        }
    });
...
let pluginInlineChunk = ()=>({
        ...
        setup (api) {
            ...
            api.processAssets({
                ...
                if (inlineScripts && (!0 === inlineScripts ? isProdMode && scriptTests.push(JS_REGEX) : (0, __WEBPACK_EXTERNAL_MODULE_node_util_types__.isRegExp)(inlineScripts) || isFunction(inlineScripts) ? isProdMode && scriptTests.push(inlineScripts) : ('auto' === inlineScripts.enable ? isProdMode : inlineScripts.enable) && scriptTests.push(inlineScripts.test)), inlineStyles && (!0 === inlineStyles ? isProdMode && styleTests.push(CSS_REGEX) : (0, __WEBPACK_EXTERNAL_MODULE_node_util_types__.isRegExp)(inlineStyles) || isFunction(inlineStyles) ? isProdMode && styleTests.push(inlineStyles) : ('auto' === inlineStyles.enable ? isProdMode : inlineStyles.enable) && styleTests.push(inlineStyles.test)), !scriptTests.length && !styleTests.length) return {
                    headTags,
                    bodyTags
                };
    ...
    return !1 !== minify && isProd ? !0 === minify ? {
        ...
        setup (api) {
            ...
            api.modifyBundlerChain(async (chain, { isProd, environment, CHAIN_ID })=>{
                ...
                if (chain.optimization.minimize(minifyJs || minifyCss), minifyJs && isRspack && chain.optimization.minimizer(CHAIN_ID.MINIMIZER.JS).use(__WEBPACK_EXTERNAL_MODULE__rspack_core__.rspack.SwcJsMinimizerRspackPlugin, [
                    getSwcMinimizerOptions(config, jsOptions)
                    ...
                    chain.optimization.minimizer(CHAIN_ID.MINIMIZER.CSS).use(__WEBPACK_EXTERNAL_MODULE__rspack_core__.rspack.LightningCssMinimizerRspackPlugin, [
                        mergedOptions
                    ]).end();
                }
            });
...
class PatchSplitChunksPlugin {
    apply(compiler) {
        ...
        let applyPatch = (cacheGroup)=>{
            if ('object' != typeof cacheGroup || (0, __WEBPACK_EXTERNAL_MODULE_node_util_types__.isRegExp)(cacheGroup)) return;
    ...
    constructor(name){
        var obj, key, value;
        obj = this, value = void 0, (key = "name") in obj ? Object.defineProperty(obj, key, {
            value: value,
            enumerable: !0,
            configurable: !0,
            writable: !0
        }) : obj[key] = value, this.name = name;
    }
}
let pluginMoment = ()=>({
        name: 'rsbuild:moment',
    ...
    let message = function(urls, routes) {
        if (routes.length <= 1) {
            ...
            return urls.map(({ label, url })=>{
                let normalizedPathname = normalizeUrl(`${url}${pathname}`), prefix = `➜ ${__WEBPACK_EXTERNAL_MODULE__compiled_picocolors_index_js__.default.dim(label.padEnd(10))}`;
                return `  ${prefix}${__WEBPACK_EXTERNAL_MODULE__compiled_picocolors_index_js__.default.cyan(normalizedPathname)}\n`;
            }).join('');
        }
        let message = '', maxNameLength = Math.max(...routes.map((r)=>r.entryName.length));
        return urls.forEach(({ label, url }, index)=>{
            for (let r of (index > 0 && (message += '\n'), message += `  ➜ ${label}\n`, routes))message += `  ${__WEBPACK_EXTERNAL_MODULE__compiled_picocolors_index_js__.default.dim('-')} ${__WEBPACK_EXTERNAL_MODULE__compiled_picocolors_index_js__.default.dim(r.entryName.padEnd(maxNameLength + 4))}${__WEBPACK_EXTERNAL_MODULE__compiled_picocolors_index_js__.default.cyan(normalizeUrl(`${url}${r.pathname}`))}\n`;
        }), message;
    }(urls, routes);
    return !1 === trailingLineBreak && message.endsWith('\n') && (message = message.slice(0, -1)), __WEBPACK_EXTERNAL_MODULE__compiled_rslog_index_js__.logger.log(message), message;
}
let getPort = async ({ host, port, strictPort, tryLimits = 20 })=>{
    ...
    for(; !found && attempts <= tryLimits;)try {
        await new Promise((resolve, reject)=>{
            let server = __WEBPACK_EXTERNAL_MODULE_node_net__.default.createServer();
    ...
    }), https = !!config.server.https, portTip = port !== originalPort ? `Port ${originalPort} is in use, ${__WEBPACK_EXTERNAL_MODULE__compiled_picocolors_index_js__.default.yellow(`using port ${port}.`)}` : void 0;
    return {
        port,
        host,
        https,
    ...
    let interfaces = __WEBPACK_EXTERNAL_MODULE_node_os__.default.networkInterfaces(), ipv4Interfaces = new Map();
    ...
    ].includes(host), getHostInUrl = (host)=>host === DEFAULT_DEV_HOST ? 'localhost' : __WEBPACK_EXTERNAL_MODULE_node_net__.default.isIPv6(host) ? '::' === host ? '[::1]' : `[${host}]` : host, concatUrl = ({ host, port, protocol })=>`${protocol}://${host}:${port}`, LOCAL_LABEL = 'Local:  ', NETWORK_LABEL = 'Network:  ', getUrlLabel = (url)=>{
    try {
...
let execAsync = (0, __WEBPACK_EXTERNAL_MODULE_node_util__.promisify)(external_node_child_process_.exec), supportedChromiumBrowsers = [
...
async function openBrowser(url) {
    if ('darwin' === process.platform) try {
        ...
        __WEBPACK_EXTERNAL_MODULE__compiled_rslog_index_js__.logger.debug('Failed to find the target browser.');
    } catch (err) {
        __WEBPACK_EXTERNAL_MODULE__compiled_rslog_index_js__.logger.debug('Failed to open start URL with apple script.'), __WEBPACK_EXTERNAL_MODULE__compiled_rslog_index_js__.logger.debug(err);
    }
    try {
        let { default: open } = await import("../compiled/open/index.js");
        return await open(url), !0;
    } catch (err) {
        return __WEBPACK_EXTERNAL_MODULE__compiled_rslog_index_js__.logger.error('Failed to open start URL.'), __WEBPACK_EXTERNAL_MODULE__compiled_rslog_index_js__.logger.error(err), !1;
    }
}
...
let getJsAsyncPath = (jsPath, isServer, jsAsync)=>void 0 !== jsAsync ? jsAsync : isServer ? jsPath : jsPath ? `${jsPath}/async` : 'async', pluginOutput = ()=>({
        ...
        setup (api) {
            api.modifyBundlerChain(async (chain, { CHAIN_ID, target, isProd, isServer, environment })=>{
                ...
                if (chain.output.path(distPath).filename(isJsFilenameFn ? (...args)=>{
                    ...
                    chain.plugin(CHAIN_ID.PLUGIN.COPY).use(__WEBPACK_EXTERNAL_MODULE__rspack_core__.rspack.CopyRspackPlugin, [
                        options
                    ]);
                }
                let emitCss = config.output.emitCss ?? 'web' === target;
        ...
        setup (api) {
            if ('webpack' !== api.context.bundlerType) api.modifyBundlerChain(async (chain, { CHAIN_ID, environment })=>{
                ...
                chain.plugin(CHAIN_ID.PLUGIN.PROGRESS).use(__WEBPACK_EXTERNAL_MODULE__rspack_core__.rspack.ProgressPlugin, [
                    {
                        prefix,
                        ...!0 === options ? {} : options
                    }
            ...
            getHTMLPlugin().getHooks(compilation).beforeAssetTagGeneration.tap(`HTML${upperFirst(this.type)}Plugin`, (htmlPluginData)=>(this.resourceHints = function(options, type, compilation, htmlPluginData, HTMLCount) {
                    ...
                    for (let file of sortedFilteredFiles){
                        ...
                        'preload' === type && (attributes.as = function({ href, file }) {
                            let url = new __WEBPACK_EXTERNAL_MODULE_node_url__.URL(file || href, 'https://example.com'), extension = external_node_path_.default.extname(url.pathname).slice(1);
                            return [
                                'css'
...
let resourceHints_generateLinks = (options, rel)=>options.map((option)=>({
    ...
    }), rsdoctor_require = (0, __WEBPACK_EXTERNAL_MODULE_node_module__.createRequire)(import.meta.url), pluginRsdoctor = ()=>({
        ...
        setup (api) {
            api.onBeforeCreateCompiler(async ({ bundlerConfigs })=>{
                ...
                try {
                    ...
                    __WEBPACK_EXTERNAL_MODULE__compiled_rslog_index_js__.logger.warn(`\`process.env.RSDOCTOR\` enabled, please install ${__WEBPACK_EXTERNAL_MODULE__compiled_picocolors_index_js__.default.bold(__WEBPACK_EXTERNAL_MODULE__compiled_picocolors_index_js__.default.yellow(packageName))} package.`);
                    return;
                }
                try {
                    module = await import(packagePath);
                } catch (err) {
                    __WEBPACK_EXTERNAL_MODULE__compiled_rslog_index_js__.logger.error(`\`process.env.RSDOCTOR\` enabled, but failed to load ${__WEBPACK_EXTERNAL_MODULE__compiled_picocolors_index_js__.default.bold(__WEBPACK_EXTERNAL_MODULE__compiled_picocolors_index_js__.default.yellow(packageName))} module.`);
                    return;
                }
                if (!!module && !!module[pluginName]) {
                    for (let config of bundlerConfigs)config.plugins ||= [], config.plugins.push(new module[pluginName]());
                    __WEBPACK_EXTERNAL_MODULE__compiled_rslog_index_js__.logger.info(`${__WEBPACK_EXTERNAL_MODULE__compiled_picocolors_index_js__.default.bold(__WEBPACK_EXTERNAL_MODULE__compiled_picocolors_index_js__.default.yellow(packageName))} enabled.`);
                }
            });
        }
    ...
    if (!!profileSession) profileSession.post('Profiler.stop', (error, param)=>{
        if (error) {
            __WEBPACK_EXTERNAL_MODULE__compiled_rslog_index_js__.logger.error('Failed to generate JS CPU profile:', error);
            return;
        }
        external_node_fs_.default.writeFileSync(output, JSON.stringify(param.profile));
    });
}, pluginRspackProfile = ()=>({
        ...
        async setup (api) {
            ...
            let timestamp = Date.now(), profileDirName = `rspack-profile-${timestamp}`, enableProfileTrace = 'ALL' === RSPACK_PROFILE || RSPACK_PROFILE.includes('TRACE'), enableCPUProfile = 'ALL' === RSPACK_PROFILE || RSPACK_PROFILE.includes('CPU'), enableLogging = 'ALL' === RSPACK_PROFILE || RSPACK_PROFILE.includes('LOGGING'), onStart = ()=>{
                let profileDir = external_node_path_.default.join(api.context.distPath, profileDirName), traceFilePath = external_node_path_.default.join(profileDir, 'trace.json');
                !external_node_fs_.default.existsSync(profileDir) && external_node_fs_.default.mkdirSync(profileDir, {
                    recursive: !0
                }), enableProfileTrace && __WEBPACK_EXTERNAL_MODULE__rspack_core__.default.experiments.globalTrace.register('trace', 'chrome', traceFilePath), enableCPUProfile && ((profileSession = new __WEBPACK_EXTERNAL_MODULE_node_inspector__.default.Session()).connect(), profileSession.post('Profiler.enable'), profileSession.post('Profiler.start'));
            };
            api.onBeforeBuild(({ isFirstCompile })=>{
                isFirstCompile && onStart();
            }), api.onBeforeStartDevServer(onStart), api.onAfterBuild(async ({ stats })=>{
                let loggingFilePath = external_node_path_.default.join(api.context.distPath, profileDirName, 'logging.json');
                if (enableLogging && stats) {
                    ...
                    external_node_fs_.default.writeFileSync(loggingFilePath, JSON.stringify(logging));
                }
            }), api.onExit(()=>{
                enableProfileTrace && __WEBPACK_EXTERNAL_MODULE__rspack_core__.default.experiments.globalTrace.cleanup();
                let profileDir = external_node_path_.default.join(api.context.distPath, profileDirName);
                stopProfiler(external_node_path_.default.join(profileDir, 'jscpuprofile.json'), profileSession), __WEBPACK_EXTERNAL_MODULE__compiled_rslog_index_js__.logger.info(`Saved Rspack profile file to ${profileDir}`);
            });
        }
    }), pluginServer = ()=>({
        name: 'rsbuild:server',
    ...
    'split-by-size': function(ctx) {
        ...
        return (0, __WEBPACK_EXTERNAL_MODULE_node_assert__.default)('split-by-size' === userConfig.strategy), {
            ...defaultConfig,
        ...
        setup (api) {
            ...
            let replaceIntegrity = (htmlContent, assets, algorithm, integrityCache)=>{
                let matches = htmlContent.matchAll(/integrity="RSBUILD_INTEGRITY_PLACEHOLDER:([^"]+)"/g), replacedHtml = htmlContent, calcIntegrity = (algorithm, assetName, data)=>{
                    ...
                    let hash = __WEBPACK_EXTERNAL_MODULE_node_crypto__.default.createHash(algorithm).update(data).digest().toString('base64'), integrity = `${algorithm}-${hash}`;
                ...
                for (let match of matches){
                    ...
                    } else __WEBPACK_EXTERNAL_MODULE__compiled_rslog_index_js__.logger.debug(`[rsbuild:sri] failed to generate integrity for ${assetName}.`), replacedHtml = replacedHtml.replace(`integrity="${placeholder}${assetName}"`, '');
                }
                return replacedHtml;
            };
            api.processAssets({
    ...
    }), swc_require = (0, __WEBPACK_EXTERNAL_MODULE_node_module__.createRequire)(import.meta.url), builtinSwcLoaderName = 'builtin:swc-loader', pluginSwc = ()=>({
...
async function applyCoreJs(swcConfig, polyfillMode) {
    let coreJsPath = swc_require.resolve('core-js/package.json'), version = getCoreJsVersion(coreJsPath), coreJsDir = external_node_path_.default.dirname(coreJsPath);
...
async function modifyBundlerChain(context, utils) {
    ...
    __WEBPACK_EXTERNAL_MODULE__compiled_rslog_index_js__.logger.debug('modify bundler chain');
    let bundlerChain = new __WEBPACK_EXTERNAL_MODULE__compiled_rspack_chain_index_js__.default(), [modifiedBundlerChain] = await context.hooks.modifyBundlerChain.callInEnvironment({
    ...
    return __WEBPACK_EXTERNAL_MODULE__compiled_rslog_index_js__.logger.debug('modify bundler chain done'), modifiedBundlerChain;
}
...
async function modifyRspackConfig(context, rspackConfig, utils) {
    var _utils_environment_config_tools;
    __WEBPACK_EXTERNAL_MODULE__compiled_rslog_index_js__.logger.debug('modify Rspack config');
    ...
    })), __WEBPACK_EXTERNAL_MODULE__compiled_rslog_index_js__.logger.debug('modify Rspack config done'), modifiedConfig;
}
async function getConfigUtils(config, chainUtils) {
    let { merge } = await import("../compiled/webpack-merge/index.js");
    return {
        ...chainUtils,
        rspack: __WEBPACK_EXTERNAL_MODULE__rspack_core__.rspack,
        mergeConfig: merge,
        addRules (rules) {
...
async function generateRspackConfig({ target, context, environment }) {
    let chainUtils = getChainUtils(target, context.environments[environment]), { BannerPlugin, DefinePlugin, IgnorePlugin, ProvidePlugin, HotModuleReplacementPlugin } = __WEBPACK_EXTERNAL_MODULE__rspack_core__.rspack, rspackConfig = chainToConfig(await modifyBundlerChain(context, {
        ...chainUtils,
        bundler: {
            BannerPlugin,
            DefinePlugin,
...
async function modifyRsbuildConfig(context) {
    __WEBPACK_EXTERNAL_MODULE__compiled_rslog_index_js__.logger.debug('modify Rsbuild config');
    let [modified] = await context.hooks.modifyRsbuildConfig.call(context.config, {
        mergeRsbuildConfig: mergeRsbuildConfig
    });
    context.config = modified, __WEBPACK_EXTERNAL_MODULE__compiled_rslog_index_js__.logger.debug('modify Rsbuild config done');
}
async function modifyEnvironmentConfig(context, config, name) {
    __WEBPACK_EXTERNAL_MODULE__compiled_rslog_index_js__.logger.debug(`modify Rsbuild environment(${name}) config`);
    ...
    return __WEBPACK_EXTERNAL_MODULE__compiled_rslog_index_js__.logger.debug(`modify Rsbuild environment(${name}) config done`), modified;
}
...
function setupCliShortcuts({ help = !0, openPage, closeServer, printUrls, restartServer, customShortcuts }) {
    let shortcuts = [
        {
            key: 'c',
            description: `${__WEBPACK_EXTERNAL_MODULE__compiled_picocolors_index_js__.default.bold('c + enter')}  ${__WEBPACK_EXTERNAL_MODULE__compiled_picocolors_index_js__.default.dim('clear console')}`,
            action: ()=>{
                console.clear();
            }
        },
        {
            key: 'o',
            description: `${__WEBPACK_EXTERNAL_MODULE__compiled_picocolors_index_js__.default.bold('o + enter')}  ${__WEBPACK_EXTERNAL_MODULE__compiled_picocolors_index_js__.default.dim('open in browser')}`,
            action: openPage
        },
        {
            key: 'q',
            description: `${__WEBPACK_EXTERNAL_MODULE__compiled_picocolors_index_js__.default.bold('q + enter')}  ${__WEBPACK_EXTERNAL_MODULE__compiled_picocolors_index_js__.default.dim('quit process')}`,
            action: async ()=>{
                try {
                    await closeServer();
                } finally{
        ...
        restartServer ? {
            key: 'r',
            description: `${__WEBPACK_EXTERNAL_MODULE__compiled_picocolors_index_js__.default.bold('r + enter')}  ${__WEBPACK_EXTERNAL_MODULE__compiled_picocolors_index_js__.default.dim('restart server')}`,
            action: restartServer
        } : null,
        {
            key: 'u',
            description: `${__WEBPACK_EXTERNAL_MODULE__compiled_picocolors_index_js__.default.bold('u + enter')}  ${__WEBPACK_EXTERNAL_MODULE__compiled_picocolors_index_js__.default.dim('show urls')}`,
            action: printUrls
        }
    ].filter(Boolean);
    ...
    return rl.on('line', (input)=>{
        if ('h' === input) {
            ...
            __WEBPACK_EXTERNAL_MODULE__compiled_rslog_index_js__.logger.log(message);
        }
...
class SocketServer {
    ...
    async prepare() {
        ...
        this.wsServer = new ws.Server({
            ...
            this.onConnect(socket, queryStr ? (0, __WEBPACK_EXTERNAL_MODULE_node_querystring__.parse)(queryStr) : {});
        });
    }
    updateStats(stats) {
...
let SYNTHETIC_MODULES_STORE = '__SYNTHETIC_MODULES_STORE', asModule = async (something, context, unlinked)=>{
    if (something instanceof __WEBPACK_EXTERNAL_MODULE_node_vm__.default.Module) return something;
...
class BasicRunner {
    ...
    getFile(modulePath, currentDirectory) {
        ...
        if (isRelativePath(modulePath)) {
            let p = external_node_path_.default.join(currentDirectory, modulePath);
            return {
                path: p,
...
let cjs_require = (0, __WEBPACK_EXTERNAL_MODULE_node_module__.createRequire)(import.meta.url), cjs_define = (...args)=>{
    args.pop()();
};
class CommonJsRunner extends BasicRunner {
    ...
    createCjsRequirer() {
        ...
        ${file.content}
            ...
            return this.preExecute(code, file), (this._options.runInNewContext ? __WEBPACK_EXTERNAL_MODULE_node_vm__.default.runInNewContext(code, this.globalContext, file.path) : __WEBPACK_EXTERNAL_MODULE_node_vm__.default.runInThisContext(code, file.path)).call(m.exports, ...argValues), this.postExecute(m, file), m.exports;
        };
    }
}
...
class EsmRunner extends CommonJsRunner {
    ...
    createEsmRequirer() {
        let esmContext = __WEBPACK_EXTERNAL_MODULE_node_vm__.default.createContext(this.baseModuleScope, {
        ...
        return (currentDirectory, modulePath, context = {})=>{
            ...
            return (!esm && (esm = new __WEBPACK_EXTERNAL_MODULE_node_vm__.default.SourceTextModule(file.content, {
                identifier: `${esmIdentifier}-${file.path}`,
                url: `${(0, __WEBPACK_EXTERNAL_MODULE_node_url__.pathToFileURL)(file.path).href}?${esmIdentifier}`,
                context: esmContext,
                initializeImportMeta: (meta, _)=>{
                    meta.url = (0, __WEBPACK_EXTERNAL_MODULE_node_url__.pathToFileURL)(file.path).href;
                },
                importModuleDynamically: async (specifier, module)=>{
                    let result = await _require(external_node_path_.default.dirname(file.path), specifier, {
                        esmMode: type_EsmMode.Evaluated
                    });
                    return await asModule(result, module.context);
                }
            }), esmCache.set(file.path, esm)), context.esmMode === type_EsmMode.Unlinked) ? esm : (async ()=>{
                if (await esm.link(async (specifier, referencingModule)=>await asModule(await _require(external_node_path_.default.dirname(referencingModule.identifier ? referencingModule.identifier.slice(esmIdentifier.length + 1) : (0, __WEBPACK_EXTERNAL_MODULE_node_url__.fileURLToPath)(referencingModule.url)), specifier, {
...
let run = async (bundlePath, outputPath, compilerOptions, readFileSync)=>new BasicRunnerFactory(bundlePath).create(compilerOptions, outputPath, readFileSync).run(bundlePath), loadBundle = async (stats, entryName, utils)=>{
    ...
    return void 0 === size || Number(size) > 1024;
}, gzipMiddleware = ({ level = __WEBPACK_EXTERNAL_MODULE_node_zlib__.default.constants.Z_BEST_SPEED } = {})=>(req, res, next)=>{
        ...
        let started = !1, { end, write, on, writeHead } = res, listeners = [], start = ()=>{
            if (!started) {
                if (started = !0, shouldCompress(res)) for (let listener of (res.setHeader('Content-Encoding', 'gzip'), res.removeHeader('Content-Length'), (gzip = __WEBPACK_EXTERNAL_MODULE_node_zlib__.default.createGzip({
                    level
                })).on('data', (chunk)=>{
...
}, getStatusCodeColor = (status)=>status >= 500 ? __WEBPACK_EXTERNAL_MODULE__compiled_picocolors_index_js__.default.red : status >= 400 ? __WEBPACK_EXTERNAL_MODULE__compiled_picocolors_index_js__.default.yellow : status >= 300 ? __WEBPACK_EXTERNAL_MODULE__compiled_picocolors_index_js__.default.cyan : status >= 200 ? __WEBPACK_EXTERNAL_MODULE__compiled_picocolors_index_js__.default.green : (res)=>res, getRequestLoggerMiddleware = async ()=>{
    ...
    return (req, res, next)=>{
        ...
        onFinished(res, ()=>{
            ...
            __WEBPACK_EXTERNAL_MODULE__compiled_rslog_index_js__.logger.debug(`${statusColor(status)} ${method} ${__WEBPACK_EXTERNAL_MODULE__compiled_picocolors_index_js__.default.gray(url)} ${__WEBPACK_EXTERNAL_MODULE__compiled_picocolors_index_js__.default.gray(`${totalTime.toFixed(3)} ms`)}`);
        }), next();
    };
    ...
    return 'string' == typeof accept && (accept.includes('text/html') || accept.includes('*/*'));
        ...
        if (await middlewares_isFileExists(filePath, outputFileSystem)) {
            ...
            return 'verbose' === __WEBPACK_EXTERNAL_MODULE__compiled_rslog_index_js__.logger.level && __WEBPACK_EXTERNAL_MODULE__compiled_rslog_index_js__.logger.debug(`${req.method} ${__WEBPACK_EXTERNAL_MODULE__compiled_picocolors_index_js__.default.gray(`${req.url} ${__WEBPACK_EXTERNAL_MODULE__compiled_picocolors_index_js__.default.yellow('fallback')} to ${newUrl}`)}`), req.url = newUrl, callback(req, res, (...args)=>next(...args));
        }
        next();
  ...
  <body>
    <h1>Assets Report</h1>
            ...
            try {
                ...
                __WEBPACK_EXTERNAL_MODULE__compiled_rslog_index_js__.logger.error(err), res.writeHead(500), res.end('Failed to list the files');
            }
        } else next();
    ...
    let formattedOptions = function(proxyOptions) {
        ...
        let handleError = (err)=>__WEBPACK_EXTERNAL_MODULE__compiled_rslog_index_js__.logger.error(err);
    ...
    'verbose' === __WEBPACK_EXTERNAL_MODULE__compiled_rslog_index_js__.logger.level && middlewares.push(await getRequestLoggerMiddleware());
...
async function devServer_createDevServer(options, createCompiler, config, { compiler: customCompiler, getPortSilently, runCompile = !0 } = {}) {
    let lastStats;
    __WEBPACK_EXTERNAL_MODULE__compiled_rslog_index_js__.logger.debug('create dev server');
    ...
    let outputFileSystem = external_node_fs_.default, waitFirstCompileDone = runCompile ? new Promise((resolve)=>{
        ...
        return await compilerDevMiddleware.init(), outputFileSystem = (isMultiCompiler(compiler) ? compiler.compilers[0].outputFileSystem : compiler.outputFileSystem) || external_node_fs_.default, {
    ...
    let devServerAPI = {
        ...
        listen: async ()=>{
            ...
            return __WEBPACK_EXTERNAL_MODULE__compiled_rslog_index_js__.logger.debug('listen dev server'), options.context.hooks.onCloseDevServer.tap(serverTerminator), new Promise((resolve)=>{
                httpServer.listen({
                    host,
                    port
                }, async (err)=>{
                    if (err) throw err;
                    middlewares.use(notFoundMiddleware), httpServer.on('upgrade', devMiddlewares.onUpgrade), __WEBPACK_EXTERNAL_MODULE__compiled_rslog_index_js__.logger.debug('listen dev server done'), await devServerAPI.afterListen(), onBeforeRestartServer(devServerAPI.close), resolve({
                        port,
                        urls: urls.map((item)=>item.url),
                        server: {
...
async function createCompiler_createCompiler(options) {
    ...
    let done = (stats)=>{
        let statsOptions = getStatsOptions(compiler), statsJson = stats.toJson({
            ...
            if (c.time) {
                ...
                __WEBPACK_EXTERNAL_MODULE__compiled_rslog_index_js__.logger.ready(`Built in ${time}${suffix}`);
            }
        ...
        'error' === level && __WEBPACK_EXTERNAL_MODULE__compiled_rslog_index_js__.logger.error(message), 'warning' === level && __WEBPACK_EXTERNAL_MODULE__compiled_rslog_index_js__.logger.warn(message), isCompiling = !1;
    };
    return compiler.hooks.done.tap('rsbuild:done', (stats)=>{
        ...
        compiler,
        bundlerConfigs: rspackConfigs,
        MultiStatsCtor: __WEBPACK_EXTERNAL_MODULE__rspack_core__.rspack.MultiStats
    }), await context.hooks.onAfterCreateCompiler.call({
        compiler,
        environments: context.environments
    }), __WEBPACK_EXTERNAL_MODULE__compiled_rslog_index_js__.logger.debug('create compiler done'), {
        compiler,
        rspackConfigs
    };
}
let build_build = async (initOptions, { watch, compiler: customCompiler } = {})=>{
    ...
    if (registerBuildHook({
        ...
        err && __WEBPACK_EXTERNAL_MODULE__compiled_rslog_index_js__.logger.error(err);
    }), {
    ...
    let { stats } = await new Promise((resolve, reject)=>{
        compiler.run((err, stats)=>{
            err ? reject(err) : (null == stats ? void 0 : stats.hasErrors()) ? reject(Error('Rspack build failed!')) : compiler.close((closeErr)=>{
                closeErr && __WEBPACK_EXTERNAL_MODULE__compiled_rslog_index_js__.logger.error(closeErr), resolve({
                    stats
                });
            });
        });
...
async function startProdServer(context, config, { getPortSilently } = {}) {
    ...
    return await server.onInit(httpServer), new Promise((resolve)=>{
        httpServer.listen({
            ...
            !getPortSilently && portTip && __WEBPACK_EXTERNAL_MODULE__compiled_rslog_index_js__.logger.info(portTip), resolve({
                port,
                urls: urls.map((item)=>item.url),
                server: {
                    close: closeServer
        ...
        pluginManifest(),
        {
            ...
            setup (api) {
                if ('webpack' !== api.context.bundlerType) api.modifyRsbuildConfig((config)=>{
                    ...
                    chain.plugin(CHAIN_ID.PLUGIN.MODULE_FEDERATION).use(__WEBPACK_EXTERNAL_MODULE__rspack_core__.rspack.container.ModuleFederationPlugin, [
                        options
                ...
                if (!!newPlugin) if (!function(plugin) {
                    ...
                    if (!isFunction(plugin.setup)) {
                        if (isFunction(plugin.apply)) {
                            ...
                            throw Error([
                                `${__WEBPACK_EXTERNAL_MODULE__compiled_picocolors_index_js__.default.yellow(name)} looks like a Webpack or Rspack plugin, please use ${__WEBPACK_EXTERNAL_MODULE__compiled_picocolors_index_js__.default.yellow('`tools.rspack`')} to register it:`,
                                __WEBPACK_EXTERNAL_MODULE__compiled_picocolors_index_js__.default.green(`
  // rsbuild.config.ts
  export default {
    tools: {
      rspack: {
...
`)
                    ...
                    -1 === index ? (__WEBPACK_EXTERNAL_MODULE__compiled_rslog_index_js__.logger.warn(`Plugin "${before}" does not exist.`), plugins.push({
                        environment,
                        instance: newPlugin
        ...
        let { hooks } = context, publicContext = function(context) {
            ...
            return new Proxy(context, {
                ...
                set: (_, prop)=>(__WEBPACK_EXTERNAL_MODULE__compiled_rslog_index_js__.logger.error(`Context is readonly, you can not assign to the "context.${prop}" prop.`), !0)
            });
        }(context);
    ...
    __WEBPACK_EXTERNAL_MODULE__compiled_rslog_index_js__.logger.debug('add default plugins'), await applyDefaultPlugins(pluginManager, context), __WEBPACK_EXTERNAL_MODULE__compiled_rslog_index_js__.logger.debug('add default plugins done');
    let provider = rsbuildConfig.provider || rspackProvider, providerInstance = await provider({
        ...
        while (plugins.some((v)=>(0, __WEBPACK_EXTERNAL_MODULE_node_util_types__.isPromise)(v)));
        return plugins;
    };
