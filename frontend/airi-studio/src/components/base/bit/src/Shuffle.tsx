...
export interface ShuffleProps {
  ...
  textStroke?: string;  // 字体描边颜色
  textStrokeWidth?: string;  // 字体描边宽度
  textShadow?: string;  // 字体阴影 (轮廓效果)
}
...
const Shuffle: React.FC<ShuffleProps> = ({
  ...
  const commonStyle: React.CSSProperties = {
    ...
    ...(textStroke && textStrokeWidth ? { 
      WebkitTextStroke: `${textStrokeWidth} ${textStroke}`,
      textStroke: `${textStrokeWidth} ${textStroke}`  // For non-webkit browsers
    } : {}),
