...
export const ResourceCopyRetryRequestCodec: thrift.IStructCodec<IResourceCopyRetryRequestArgs, IResourceCopyRetryRequest> = {
    ...
    decode(input: thrift.TProtocol): IResourceCopyRetryRequest {
        let _args: any = {};
...
export class ResourceCopyRetryRequest extends thrift.StructLike implements IResourceCopyRetryRequest {
    ...
    public static read(input: thrift.TProtocol): ResourceCopyRetryRequest {
        return new ResourceCopyRetryRequest(ResourceCopyRetryRequestCodec.decode(input));
    }
    public static write(args: IResourceCopyRetryRequestArgs, output: thrift.TProtocol): void {
        return ResourceCopyRetryRequestCodec.encode(args, output);
    }
    public write(output: thrift.TProtocol): void {
        return ResourceCopyRetryRequestCodec.encode(this, output);
    }
}
