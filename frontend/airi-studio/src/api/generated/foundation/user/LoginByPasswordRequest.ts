...
export const LoginByPasswordRequestCodec: thrift.IStructCodec<ILoginByPasswordRequestArgs, ILoginByPasswordRequest> = {
    ...
    decode(input: thrift.TProtocol): ILoginByPasswordRequest {
        let _args: any = {};
...
export class LoginByPasswordRequest extends thrift.StructLike implements ILoginByPasswordRequest {
    ...
    constructor(args: ILoginByPasswordRequestArgs = {}) {
        ...
        if (args.account != null) {
            const value_4: string = args.account;
            this.account = value_4;
        }
    ...
    public static read(input: thrift.TProtocol): LoginByPasswordRequest {
        return new LoginByPasswordRequest(LoginByPasswordRequestCodec.decode(input));
    }
    public static write(args: ILoginByPasswordRequestArgs, output: thrift.TProtocol): void {
        return LoginByPasswordRequestCodec.encode(args, output);
    }
    public write(output: thrift.TProtocol): void {
        return LoginByPasswordRequestCodec.encode(this, output);
    }
}
