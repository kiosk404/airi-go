...
export const DeletePromptResourceRequestCodec: thrift.IStructCodec<IDeletePromptResourceRequestArgs, IDeletePromptResourceRequest> = {
    ...
    decode(input: thrift.TProtocol): IDeletePromptResourceRequest {
        let _args: any = {};
        ...
        if (_args.PromptResourceID !== undefined) {
            ...
            throw new thrift.TProtocolException(thrift.TProtocolExceptionType.UNKNOWN, "Unable to read DeletePromptResourceRequest from input");
        }
    }
};
export class DeletePromptResourceRequest extends thrift.StructLike implements IDeletePromptResourceRequest {
    ...
    public static read(input: thrift.TProtocol): DeletePromptResourceRequest {
        return new DeletePromptResourceRequest(DeletePromptResourceRequestCodec.decode(input));
    }
    public static write(args: IDeletePromptResourceRequestArgs, output: thrift.TProtocol): void {
        return DeletePromptResourceRequestCodec.encode(args, output);
    }
    public write(output: thrift.TProtocol): void {
        return DeletePromptResourceRequestCodec.encode(this, output);
    }
}
