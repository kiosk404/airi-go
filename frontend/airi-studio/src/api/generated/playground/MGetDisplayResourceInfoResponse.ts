...
export const MGetDisplayResourceInfoResponseCodec: thrift.IStructCodec<IMGetDisplayResourceInfoResponseArgs, IMGetDisplayResourceInfoResponse> = {
    encode(args: IMGetDisplayResourceInfoResponseArgs, output: thrift.TProtocol): void {
        ...
        if (obj.ResourceList != null) {
            output.writeFieldBegin("ResourceList", thrift.TType.LIST, 1);
            output.writeListBegin(thrift.TType.STRUCT, obj.ResourceList.length);
            obj.ResourceList.forEach((value_1: DisplayResourceInfo.IDisplayResourceInfoArgs): void => {
                DisplayResourceInfo.DisplayResourceInfoCodec.encode(value_1, output);
            });
            output.writeListEnd();
    ...
    decode(input: thrift.TProtocol): IMGetDisplayResourceInfoResponse {
        let _args: any = {};
            ...
            switch (fieldId) {
                case 1:
                    if (fieldType === thrift.TType.LIST) {
                        const value_2: Array<DisplayResourceInfo.IDisplayResourceInfo> = new Array<DisplayResourceInfo.IDisplayResourceInfo>();
                        const metadata_1: thrift.IThriftList = input.readListBegin();
                        const size_1: number = metadata_1.size;
                        for (let i_1: number = 0; i_1 < size_1; i_1++) {
                            const value_3: DisplayResourceInfo.IDisplayResourceInfo = DisplayResourceInfo.DisplayResourceInfoCodec.decode(input);
                            value_2.push(value_3);
                        }
                        input.readListEnd();
                        _args.ResourceList = value_2;
                    }
                    else {
        ...
        if (_args.BaseResp !== undefined) {
            ...
            throw new thrift.TProtocolException(thrift.TProtocolExceptionType.UNKNOWN, "Unable to read MGetDisplayResourceInfoResponse from input");
        }
    }
};
export class MGetDisplayResourceInfoResponse extends thrift.StructLike implements IMGetDisplayResourceInfoResponse {
    ...
    public static read(input: thrift.TProtocol): MGetDisplayResourceInfoResponse {
        return new MGetDisplayResourceInfoResponse(MGetDisplayResourceInfoResponseCodec.decode(input));
    }
    public static write(args: IMGetDisplayResourceInfoResponseArgs, output: thrift.TProtocol): void {
        return MGetDisplayResourceInfoResponseCodec.encode(args, output);
    }
    public write(output: thrift.TProtocol): void {
        return MGetDisplayResourceInfoResponseCodec.encode(this, output);
    }
}
