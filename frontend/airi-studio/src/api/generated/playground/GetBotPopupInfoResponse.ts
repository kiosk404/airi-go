...
export interface IGetBotPopupInfoResponseArgs {
    data: BotPopupInfoData.IBotPopupInfoDataArgs;
    code: number | string | thrift.Int64;
    msg: string;
    base_resp: __ROOT_NAMESPACE__.IBaseRespArgs;
}
export const GetBotPopupInfoResponseCodec: thrift.IStructCodec<IGetBotPopupInfoResponseArgs, IGetBotPopupInfoResponse> = {
    encode(args: IGetBotPopupInfoResponseArgs, output: thrift.TProtocol): void {
        const obj: any = {
            data: args.data,
        ...
        output.writeStructBegin("GetBotPopupInfoResponse");
        if (obj.data != null) {
            output.writeFieldBegin("data", thrift.TType.STRUCT, 1);
            BotPopupInfoData.BotPopupInfoDataCodec.encode(obj.data, output);
    ...
    decode(input: thrift.TProtocol): IGetBotPopupInfoResponse {
        let _args: any = {};
            ...
            switch (fieldId) {
                case 1:
                    if (fieldType === thrift.TType.STRUCT) {
                        const value_1: BotPopupInfoData.IBotPopupInfoData = BotPopupInfoData.BotPopupInfoDataCodec.decode(input);
                        _args.data = value_1;
                    }
                    else {
        ...
        if (_args.data !== undefined && _args.code !== undefined && _args.msg !== undefined && _args.BaseResp !== undefined) {
            ...
            throw new thrift.TProtocolException(thrift.TProtocolExceptionType.UNKNOWN, "Unable to read GetBotPopupInfoResponse from input");
        }
    }
};
export class GetBotPopupInfoResponse extends thrift.StructLike implements IGetBotPopupInfoResponse {
    public data: BotPopupInfoData.IBotPopupInfoData;
    ...
    constructor(args: IGetBotPopupInfoResponseArgs) {
        super();
        if (args.data != null) {
            const value_5: BotPopupInfoData.IBotPopupInfoData = new BotPopupInfoData.BotPopupInfoData(args.data);
            this.data = value_5;
        }
        else {
            throw new thrift.TProtocolException(thrift.TProtocolExceptionType.UNKNOWN, "Required field[data] is unset!");
    ...
    public static read(input: thrift.TProtocol): GetBotPopupInfoResponse {
        return new GetBotPopupInfoResponse(GetBotPopupInfoResponseCodec.decode(input));
    }
    public static write(args: IGetBotPopupInfoResponseArgs, output: thrift.TProtocol): void {
        return GetBotPopupInfoResponseCodec.encode(args, output);
    }
    public write(output: thrift.TProtocol): void {
        return GetBotPopupInfoResponseCodec.encode(this, output);
    }
}
