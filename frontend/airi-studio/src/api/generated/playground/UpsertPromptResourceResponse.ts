...
import * as ShowPromptResource from "./ShowPromptResource";
import * as __ROOT_NAMESPACE__ from "../base";
export interface IUpsertPromptResourceResponse {
...
export const UpsertPromptResourceResponseCodec: thrift.IStructCodec<IUpsertPromptResourceResponseArgs, IUpsertPromptResourceResponse> = {
    encode(args: IUpsertPromptResourceResponseArgs, output: thrift.TProtocol): void {
        ...
        if (obj.data != null) {
            ...
            ShowPromptResource.ShowPromptResourceCodec.encode(obj.data, output);
    ...
    decode(input: thrift.TProtocol): IUpsertPromptResourceResponse {
        let _args: any = {};
            ...
            switch (fieldId) {
                case 1:
                    if (fieldType === thrift.TType.STRUCT) {
                        const value_1: ShowPromptResource.IShowPromptResource = ShowPromptResource.ShowPromptResourceCodec.decode(input);
                        _args.data = value_1;
                    }
                    else {
        ...
        if (_args.code !== undefined && _args.msg !== undefined && _args.BaseResp !== undefined) {
            ...
            throw new thrift.TProtocolException(thrift.TProtocolExceptionType.UNKNOWN, "Unable to read UpsertPromptResourceResponse from input");
        }
    }
};
export class UpsertPromptResourceResponse extends thrift.StructLike implements IUpsertPromptResourceResponse {
    ...
    constructor(args: IUpsertPromptResourceResponseArgs) {
        super();
        if (args.data != null) {
            const value_5: ShowPromptResource.IShowPromptResource = new ShowPromptResource.ShowPromptResource(args.data);
            this.data = value_5;
        }
        if (args.code != null) {
    ...
    public static read(input: thrift.TProtocol): UpsertPromptResourceResponse {
        return new UpsertPromptResourceResponse(UpsertPromptResourceResponseCodec.decode(input));
    }
    public static write(args: IUpsertPromptResourceResponseArgs, output: thrift.TProtocol): void {
        return UpsertPromptResourceResponseCodec.encode(args, output);
    }
    public write(output: thrift.TProtocol): void {
        return UpsertPromptResourceResponseCodec.encode(this, output);
    }
}
