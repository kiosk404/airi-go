...
export const GetUserAuthorityResponseCodec: thrift.IStructCodec<IGetUserAuthorityResponseArgs, IGetUserAuthorityResponse> = {
    encode(args: IGetUserAuthorityResponseArgs, output: thrift.TProtocol): void {
        ...
        if (obj.data != null) {
            ...
            COMPONENT_PLUGIN_DEVELOP_COMMON_NS.GetUserAuthorityDataCodec.encode(obj.data, output);
            output.writeFieldEnd();
        }
            ...
            switch (fieldId) {
                ...
                case 3:
                    if (fieldType === thrift.TType.STRUCT) {
                        const value_3: COMPONENT_PLUGIN_DEVELOP_COMMON_NS.IGetUserAuthorityData = COMPONENT_PLUGIN_DEVELOP_COMMON_NS.GetUserAuthorityDataCodec.decode(input);
                        _args.data = value_3;
                    }
                    else {
                        input.skip(fieldType);
