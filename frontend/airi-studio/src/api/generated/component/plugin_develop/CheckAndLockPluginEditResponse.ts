...
export const CheckAndLockPluginEditResponseCodec: thrift.IStructCodec<ICheckAndLockPluginEditResponseArgs, ICheckAndLockPluginEditResponse> = {
    encode(args: ICheckAndLockPluginEditResponseArgs, output: thrift.TProtocol): void {
        ...
        output.writeStructBegin("CheckAndLockPluginEditResponse");
        if (obj.code != null) {
    ...
    decode(input: thrift.TProtocol): ICheckAndLockPluginEditResponse {
        let _args: any = {};
        ...
        if (_args.code !== undefined && _args.msg !== undefined) {
            ...
            throw new thrift.TProtocolException(thrift.TProtocolExceptionType.UNKNOWN, "Unable to read CheckAndLockPluginEditResponse from input");
        }
    }
};
export class CheckAndLockPluginEditResponse extends thrift.StructLike implements ICheckAndLockPluginEditResponse {
    ...
    public static read(input: thrift.TProtocol): CheckAndLockPluginEditResponse {
        return new CheckAndLockPluginEditResponse(CheckAndLockPluginEditResponseCodec.decode(input));
    }
    public static write(args: ICheckAndLockPluginEditResponseArgs, output: thrift.TProtocol): void {
        return CheckAndLockPluginEditResponseCodec.encode(args, output);
    }
    public write(output: thrift.TProtocol): void {
        return CheckAndLockPluginEditResponseCodec.encode(this, output);
    }
}
