...
export const CreateModelRespCodec: thrift.IStructCodec<ICreateModelRespArgs, ICreateModelResp> = {
    ...
    decode(input: thrift.TProtocol): ICreateModelResp {
        let _args: any = {};
        ...
        if (_args.code !== undefined && _args.msg !== undefined && _args.BaseResp !== undefined) {
            ...
            throw new thrift.TProtocolException(thrift.TProtocolExceptionType.UNKNOWN, "Unable to read CreateModelResp from input");
        }
    }
};
export class CreateModelResp extends thrift.StructLike implements ICreateModelResp {
    ...
    public static read(input: thrift.TProtocol): CreateModelResp {
        return new CreateModelResp(CreateModelRespCodec.decode(input));
    }
    public static write(args: ICreateModelRespArgs, output: thrift.TProtocol): void {
        return CreateModelRespCodec.encode(args, output);
    }
    public write(output: thrift.TProtocol): void {
        return CreateModelRespCodec.encode(this, output);
    }
}
