...
export const UpdateModelRespCodec: thrift.IStructCodec<IUpdateModelRespArgs, IUpdateModelResp> = {
    ...
    decode(input: thrift.TProtocol): IUpdateModelResp {
        let _args: any = {};
        ...
        if (_args.code !== undefined && _args.msg !== undefined && _args.BaseResp !== undefined) {
            ...
            throw new thrift.TProtocolException(thrift.TProtocolExceptionType.UNKNOWN, "Unable to read UpdateModelResp from input");
        }
    }
};
export class UpdateModelResp extends thrift.StructLike implements IUpdateModelResp {
    ...
    constructor(args: IUpdateModelRespArgs) {
        super();
        if (args.code != null) {
    ...
    public static read(input: thrift.TProtocol): UpdateModelResp {
        return new UpdateModelResp(UpdateModelRespCodec.decode(input));
    }
    public static write(args: IUpdateModelRespArgs, output: thrift.TProtocol): void {
        return UpdateModelRespCodec.encode(args, output);
    }
    public write(output: thrift.TProtocol): void {
        return UpdateModelRespCodec.encode(this, output);
    }
}
