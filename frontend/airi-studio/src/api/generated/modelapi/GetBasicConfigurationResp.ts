...
export interface IGetBasicConfigurationRespArgs {
...
export const GetBasicConfigurationRespCodec: thrift.IStructCodec<IGetBasicConfigurationRespArgs, IGetBasicConfigurationResp> = {
    encode(args: IGetBasicConfigurationRespArgs, output: thrift.TProtocol): void {
        const obj: any = {
        ...
        output.writeStructBegin("GetBasicConfigurationResp");
    ...
    decode(input: thrift.TProtocol): IGetBasicConfigurationResp {
        let _args: any = {};
        ...
        if (_args.code !== undefined && _args.msg !== undefined && _args.BaseResp !== undefined) {
            ...
            throw new thrift.TProtocolException(thrift.TProtocolExceptionType.UNKNOWN, "Unable to read GetBasicConfigurationResp from input");
        }
    }
};
export class GetBasicConfigurationResp extends thrift.StructLike implements IGetBasicConfigurationResp {
    ...
    constructor(args: IGetBasicConfigurationRespArgs) {
        super();
        if (args.configuration != null) {
            const value_5: BasicConfiguration.IBasicConfiguration = new BasicConfiguration.BasicConfiguration(args.configuration);
            this.configuration = value_5;
        }
        if (args.code != null) {
    ...
    public static read(input: thrift.TProtocol): GetBasicConfigurationResp {
        return new GetBasicConfigurationResp(GetBasicConfigurationRespCodec.decode(input));
    }
    public static write(args: IGetBasicConfigurationRespArgs, output: thrift.TProtocol): void {
        return GetBasicConfigurationRespCodec.encode(args, output);
    }
    public write(output: thrift.TProtocol): void {
        return GetBasicConfigurationRespCodec.encode(this, output);
    }
}
